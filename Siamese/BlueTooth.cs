...
namespace JLcLib.BlueTooth.HCI
{
    using LibUsbDotNet;
    ...
    /// <summary>
    /// Paramter type of HCI commands and events
    /// </summary>
    public enum ParameterType
    {
        /// <summary>Normal data type, It has fixed data size</summary>
        NormalData = 0x00,
        /// <summary>Data size of the next resizable parameter</summary>
        ResizableIndicator = 0x01,
        /// <summary>Resizable data type, Data size is decided by data of ResizableIndicator</summary>
        ResizableData = 0x02,

        /// <summary>Array indicator. Data is the number of array size</summary>
        ArrayIndicator = 0x10,
        /// <summary>Array data type, Array size is decided ArrayIndicator. Data size is fixed</summary>
        ArrayData = 0x20,
    }
    /// <summary>
    /// Data type of HCI paramter
    /// </summary>
    public enum ParameterDataType
    {
        /// <summary>Timing parameter: N * 1usec</summary>
        Time_1usec = 1,
        /// <summary>Timing parameter: N * 0.625msec</summary>
        Time_625usec = 625,
        /// <summary>Timing parameter: N * 1.25msec</summary>
        Time_1_25msec = 1250,
        /// <summary>Timing parameter: N * 10msec</summary>
        Time_10msec = 10000,
        /// <summary>Timing parameter: N * 1sec</summary>
        Time_1sec = 1000000,
        ...
        Bytes,
        /// <summary>Decimal number, below 4 bytes</summary>
        Number,
        /// <summary>BLE channel index, 1 byte</summary>
        BLE_Channel,
        /// <summary>OpCode</summary>
        OpCode,

        /// <summary>Bluetooth specific status indicator</summary>
        Status,
        /// <summary>Bluetooth specific core version</summary>
        CoreVersion,
    }
    /// <summary>
    /// LE controller commands. Value is 10bits OCF
    /// </summary>
    public enum LEControllerCommands
    {
        /// <summary></summary>
        HCI_LE_Set_Event_Mask = 0x001,
        /// <summary></summary>
        HCI_LE_Read_Buffer_Size = 0x002,
        /// <summary></summary>
        HCI_LE_Read_Local_Supported_Features = 0x003,
        /// <summary></summary>
        HCI_LE_Set_Random_Address = 0x005,
        /// <summary></summary>
        HCI_LE_Set_Advertising_Parameters = 0x006,
        /// <summary></summary>
        HCI_LE_Read_Advertising_Channel_Tx_Power = 0x007,
        /// <summary></summary>
        HCI_LE_Set_Advertising_Data = 0x008,
        /// <summary></summary>
        HCI_LE_Set_Scan_Response_Data = 0x009,
        /// <summary></summary>
        HCI_LE_Set_Advertising_Enable = 0x00A,
        /// <summary></summary>
        HCI_LE_Set_Scan_Parameters = 0x00B,
        /// <summary></summary>
        HCI_LE_Set_Scan_Enable = 0x00C,
        /// <summary></summary>
        HCI_LE_Create_Connection = 0x00D,
        /// <summary></summary>
        HCI_LE_Create_Connection_Cancel = 0x00E,
        /// <summary></summary>
        HCI_LE_Read_White_List_Size = 0x00F,
        /// <summary></summary>
        HCI_LE_Clear_White_List = 0x010,
        /// <summary></summary>
        HCI_LE_Add_Device_To_White_List = 0x011,
        /// <summary></summary>
        HCI_LE_Remove_Device_From_White_List = 0x012,
        /// <summary></summary>
        HCI_LE_Connection_Update = 0x013,
        /// <summary></summary>
        HCI_LE_Set_Host_Channel_Classification = 0x014,
        /// <summary></summary>
        HCI_LE_Read_Channel_Map = 0x015,
        /// <summary></summary>
        HCI_LE_Read_Remote_Features = 0x016,
        /// <summary></summary>
        HCI_LE_Encrypt = 0x017,
        /// <summary></summary>
        HCI_LE_Rand = 0x018,
        /// <summary></summary>
        HCI_LE_Start_Encryption = 0x019,
        /// <summary></summary>
        HCI_LE_Long_Term_Key_Request_Reply = 0x01A,
        /// <summary></summary>
        HCI_LE_Long_Term_Key_Request_Negative_Reply = 0x01B,
        /// <summary></summary>
        HCI_LE_Read_Supported_States = 0x01C,
        /// <summary></summary>
        HCI_LE_Receiver_Test = 0x01D,
        /// <summary></summary>
        HCI_LE_Transmitter_Test = 0x01E,
        /// <summary></summary>
        HCI_LE_Test_End = 0x01F,
        /// <summary></summary>
        LE_Remote_Connection_Parameter_Request_Reply = 0x020,
        /// <summary></summary>
        LE_Remote_Connection_Parameter_Request_Negative_Reply = 0x021,
        /// <summary></summary>
        HCI_LE_Set_Data_Length = 0x022,
        /// <summary></summary>
        HCI_LE_Read_Suggested_Default_Data_Length = 0x023,
        /// <summary></summary>
        HCI_LE_Write_Suggested_Default_Data_Length = 0x024,
        /// <summary></summary>
        HCI_LE_Read_Local_P_256_Public_Key = 0x025,
        /// <summary></summary>
        HCI_LE_Generate_DHKey = 0x026,
        /// <summary></summary>
        HCI_LE_Add_Device_To_Resolving_List = 0x027,
        /// <summary></summary>
        HCI_LE_Remove_Device_From_Resolving_List = 0x028,
        /// <summary></summary>
        HCI_LE_Clear_Resolving_List = 0x029,
        /// <summary></summary>
        HCI_LE_Read_Resolving_List_Size = 0x02A,
        /// <summary></summary>
        HCI_LE_Read_Peer_Resolvable_Address = 0x02B,
        /// <summary></summary>
        HCI_LE_Read_Local_Resolvable_Address = 0x02C,
        /// <summary></summary>
        HCI_LE_Set_Address_Resolution_Enable = 0x02D,
        /// <summary></summary>
        HCI_LE_Set_Resolvable_Private_Address_Timeout = 0x02E,
        /// <summary></summary>
        HCI_LE_Read_Maximum_Data_Length = 0x02F,
        /// <summary></summary>
        HCI_LE_Read_PHY = 0x030,
        /// <summary></summary>
        HCI_LE_Set_Default_PHY = 0x031,
        /// <summary></summary>
        HCI_LE_Set_PHY = 0x032,
        /// <summary></summary>
        HCI_LE_Enhanced_Receiver_Test = 0x033,
        /// <summary></summary>
        HCI_LE_Enhanced_Transmitter_Test = 0x034,
        /// <summary></summary>
        HCI_LE_Set_Advertising_Set_Random_Address = 0x035,
        /// <summary></summary>
        HCI_LE_Set_Extended_Advertising_Parameters = 0x036,
        /// <summary></summary>
        HCI_LE_Set_Extended_Advertising_Data = 0x037,
        /// <summary></summary>
        HCI_LE_Set_Extended_Scan_Response_Data = 0x038,
        /// <summary></summary>
        HCI_LE_Set_Extended_Advertising_Enable = 0x039,
        /// <summary></summary>
        HCI_LE_Read_Maximum_Advertising_Data_Length = 0x03A,
        /// <summary></summary>
        HCI_LE_Read_Number_of_Supported_Advertising_Sets = 0x03B,
        /// <summary></summary>
        HCI_LE_Remove_Advertising_Set = 0x03C,
        /// <summary></summary>
        HCI_LE_Clear_Advertising_Sets = 0x03D,
        /// <summary></summary>
        HCI_LE_Set_Periodic_Advertising_Parameters = 0x03E,
        /// <summary></summary>
        HCI_LE_Set_Periodic_Advertising_Data = 0x03F,
        /// <summary></summary>
        HCI_LE_Set_Periodic_Advertising_Enable = 0x040,
        /// <summary></summary>
        HCI_LE_Set_Extended_Scan_Parameters = 0x041,
        /// <summary></summary>
        HCI_LE_Set_Extended_Scan_Enable = 0x042,
        /// <summary></summary>
        HCI_LE_Extended_Create_Connection = 0x043,
        /// <summary></summary>
        HCI_LE_Periodic_Advertising_Create_Sync = 0x044,
        /// <summary></summary>
        HCI_LE_Periodic_Advertising_Create_Sync_Cancel = 0x045,
        /// <summary></summary>
        HCI_LE_Periodic_Advertising_Terminate_Sync = 0x046,
        /// <summary></summary>
        HCI_LE_Add_Device_To_Periodic_Advertiser_List = 0x047,
        /// <summary></summary>
        HCI_LE_Remove_Device_From_Periodic_Advertiser_List = 0x048,
        /// <summary></summary>
        HCI_LE_Clear_Periodic_Advertiser_List = 0x049,
        /// <summary></summary>
        HCI_LE_Read_Periodic_Advertiser_List_Size = 0x04A,
        /// <summary></summary>
        HCI_LE_Read_Transmit_Power = 0x04B,
        /// <summary></summary>
        HCI_LE_Read_RF_Path_Compensation = 0x04C,
        /// <summary></summary>
        HCI_LE_Write_RF_Path_Compensation = 0x04D,
        /// <summary></summary>
        HCI_LE_Set_Privacy_Mode = 0x04E,
    }
    /// <summary>
    /// HCI event codes.
    /// </summary>
    ...
    /// <summary>
    /// Subevent codes of LE meta event.
    /// </summary>
    ...
    /// <summary>
    /// Communication types for HCI connection.
    /// </summary>
    public enum ComnType
    {
        /// <summary>Do not select connection type</summary>
        None,
        /// <summary>Selected UART connection</summary>
        Serial,
        /// <summary>Selected USB connection via LibUsb</summary>
        USB,
    }
    /// <summary>
    /// HCI packet types (UART packet header)
    /// </summary>
    ...
    /// <summary>
    /// Link layer status of state machine
    /// </summary>
    ...
    /// <summary>
    /// This delegate is used to write HCI command to target device.
    /// </summary>
    /// <param name="Cmd">HCI command class</param>
    /// <returns>true is success to write.</returns>
    public delegate bool WriteCommand(Command Cmd);

    #region HCI information class
    /// <summary>
    /// HCI information class
    /// </summary>
    public static class Information
    {
        /// <summary>HCI command status</summary>
        ...
        /// <summary>Core/HCI/LPM Version</summary>
    ...
    #region HCI command and event classes

    #region HCI paramter management classes
    /// <summary>
    /// HCI paramter class
    /// </summary>
    public class Parameter
    {
        #region Variable and properties declaration
        ...
        /// <summary>Gets or sets the number of array parameter that make up array. It is only used for ArrayIndicator</summary>
        public int ArrayDepth { get; set; }
        /// <summary>Data size of parameter</summary>
        public int Size
        {
            get { return DataSize; }
            set
            {
                if (value > DataSize)
                    ParaData.AddRange(new byte[DataSize - value]);
                else if (value < DataSize)
                    ParaData.RemoveRange(value, DataSize - value);
            }
        }
        private int DataSize = 0;
        /// <summary>Parmeter data</summary>
        //public List<byte> Data
        public List<byte> Data
        {
            get { return ParaData; }
            set { SetData(value.ToArray(), 0); }
        }
        private List<byte> ParaData = new List<byte>();
        /// <summary>Gets parameter data type</summary>
        public ParameterDataType DataType { get; }
        /// <summary>Gets or sets TreeNode for HCI commands tree</summary>
        public TreeNode Node { get; set; }
        /// <summary>Gets or sets parent class that is parameter collection class that contain this.</summary>
        ...
        /// <param name="Size">Parameter data size(unit byte)</param>
        /// <param name="DataType">Paramter data type</param>
        /// <param name="Description">Parameter description</param>
        /// <param name="Type">Paramter type</param>
        /// <param name="ArrayDepth">the number of array parameter that make up array. It is only used for ArrayIndicator.</param>
        public Parameter(string Name, int Size, ParameterDataType DataType, string Description = "", ParameterType Type = ParameterType.NormalData, int ArrayDepth = 0)
        {
            this.Name = Name;
            this.Size = Size;
        ...
        #region Paramter control methods
        /// <summary>
        /// Sets data of parameter.
        /// </summary>
        /// <param name="DataBuffer">DataBuffer is set to data of parameter</param>
        /// <param name="StartIndex">Start index of DataBuffer</param>
        /// <returns>Return value = StartIndex + Parameter data size</returns>
        public int SetData(byte[] DataBuffer, int StartIndex)
        {
            int Index = StartIndex;

            // Changes array parameters size or parameter data size.
            if ((Type & ParameterType.ArrayIndicator) != 0)
                Parent.ReallocateArray(this, ParaData[0], DataBuffer[StartIndex]);
            else if ((Type & ParameterType.ResizableIndicator) != 0)
                Parent.ResizeData(this, DataBuffer[StartIndex]);
            // Set data
            for (int i = 0; i < Size; i++)
            {
                if (Index < DataBuffer.Length)
                    ParaData[i] = DataBuffer[Index++];
                else
                    ParaData[i] = 0;
            }
            return Index;
        ...
        /// <summary>
        /// Make clone parameter without "Parent" property
        /// </summary>
        /// <param name="CopiedData">If true, Data is copied to clone. If false, Clone's data has all zero value.</param>
        /// <returns></returns>
        public Parameter Clone(bool CopiedData = true)
        {
            Parameter temp = new Parameter(Name, Size, DataType, Description, Type, ArrayDepth);
            if (CopiedData)
        ...
        private static string GetDataString(Parameter Para)
        {
            int n = 0;
            string s = "";
            ...
            switch (Para.DataType)
            {
                case ParameterDataType.Status:
                    if (Para.Data[0] < Information.ErrorCodes.Length)
                        s = Information.ErrorCodes[Para.Data[0]];
                    else
                        s = "Unknow status " + Para.Data[0].ToString("X2");
                    break;
                case ParameterDataType.S8:
                    s = ((sbyte)Para.Data[0]).ToString() + ", ";
                    goto default;
                case ParameterDataType.String:
                    for (int i = 0; i < Para.Data.Count; i++)
                    {
                        if (Para.Data[i] == 0)
                            break;
                        s += (char)Para.Data[i];
                ...
                case ParameterDataType.CoreVersion:
                    if (Para.Data[0] < Information.CoreVersion.Length)
                        s = Information.CoreVersion[Para.Data[0]];
                    else
                        s = "Unknow version " + Para.Data[0].ToString("X2");
                    break;
                ...
                case ParameterDataType.BLE_Channel:
                    s = (Para.Data[0] * 2 + 2402).ToString() + " MHz, ";
                    goto default;
                ...
                case ParameterDataType.Time_1sec:
                    for (int i = 0; i < Para.Data.Count; i++)
                        n |= (Para.Data[i] << (i * 8));
                    double t = (double)n * (int)Para.DataType;
                    if (t < 1000.0)
                        s = t.ToString("F2") + " us, ";
                    else if (t < 1000000.0)
                        s = (t / 1000.0).ToString("F2") + " ms, ";
                    else
                        s = (t / 1000000.0).ToString("F2") + " s, ";
                    goto default;
                case ParameterDataType.OpCode:
                    n = (Para.Data[1] << 8) | Para.Data[0];
                    s = "0x" + n.ToString("X4") + " (OGF=0x" + (n >> 12).ToString("X2") + ", OCF=0x" + (n & 0x3FF).ToString("X3") + ")";
                    break;

                case ParameterDataType.Bytes:
                default:
                    for (int i = Para.Data.Count - 1; i > 0; i--)
                        s += Para.Data[i].ToString("X2") + " ";
                    s += Para.Data[0].ToString("X2");
                    break;
            }
            return s;
        }
    ...
    /// <summary>
    /// HCI parameter collection class
    /// </summary>
    public class ParameterCollection : IEnumerator, IEnumerable
    {
        #region Variable and properties declaration
        private List<Parameter> ParaList = new List<Parameter>();
        /// <summary>Gets the number of parameter in this collection.</summary>
        public int Count { get { return ParaList.Count; } }
        private TreeNodeCollection ParaNodes = null;
        /// <summary>Gets the tree nodes of HCI parameter</summary>
        public TreeNodeCollection Nodes { get { return ParaNodes; } }
        /// <summary>Gets total number of parameters data length (unit : byte)</summary>
        ...
        /// Constructor
        /// </summary>
        /// <param name="Nodes">HCI command or event tree node collection</param>
        ...
        #region indexer interface methods
        private int Location = -1;
        /// <summary>
        /// Gets or sets HCI parameter at the indexed location in this collection
        /// </summary>
        /// <param name="Index">location index in this collection</param>
        /// <returns></returns>
        public Parameter this[int Index]
        {
            get { return ParaList[Index]; }
            set { ParaList[Index] = value; }
        }
        /// <summary>
        /// Reset location. location is -1
        /// </summary>
        public void Reset()
        {
            Location = -1;
        ...
        /// <summary>
        /// Gets data at current location in this collection
        /// </summary>
        public object Current { get { return ParaList[Location]; } }
        /// <summary>
        /// Move next location. If location is over array length, loaction is set by -1.
        /// </summary>
        /// <returns>true is succeed to move, false is failed to move and reset location</returns>
        ...
        #region Parameter collection methods
        /// <summary>
        /// This method is used to add the HCI parameter at this collection
        /// </summary>
        /// <param name="Name">Parameter name</param>
        /// <param name="Size">Number of parameter in bytes</param>
        /// <param name="DataType">Parameter data type for encoding</param>
        /// <param name="Description">Parameter description</param>
        /// <param name="Type">Parameter type</param>
        /// <param name="ArrayDepth">the number of array parameter that make up array. It is only used for ArrayIndicator.</param>
        /// <returns>Added parameter class</returns>
        public Parameter Add(string Name, byte Size, ParameterDataType DataType, string Description = "", ParameterType Type = ParameterType.NormalData, int ArrayDepth = 0)
        {
            Parameter Para = new Parameter(Name, Size, DataType, Description, Type, ArrayDepth);
            ParaList.Add(Para);
            if(ParaNodes != null)
        ...
        /// <summary>
        /// This method is used to add the HCI parameter at last of this collection
        /// </summary>
        /// <param name="Para">Paramter class</param>
        /// <returns></returns>
        public Parameter Add(Parameter Para)
        {
            ...
            if (ParaNodes != null)
                ParaNodes.Add(Para.Node);
            ParaList[ParaList.Count - 1].Parent = this;

            return Para;
        }
        /// <summary>
        /// This method is used to insert the HCI parameter at index of this collection
        /// </summary>
        /// <param name="Index">Parameter index to be inserted</param>
        /// <param name="Para">Paramter class</param>
        ...
        /// <summary>
        /// This method is used to delete the HCI parameter from this items collection
        /// </summary>
        /// <param name="Name">Parameter name that will be removed</param>
        ...
        /// This method is used to delete the HCI parameter from this items collection
        /// </summary>
        /// <param name="Index">Parameter index that will be removed</param>
        ...
        /// <summary>
        /// This method is clear all HCI parameters
        /// </summary>
        public void Clear()
        {
            ParaList.Clear();
        ...
        /// <summary>
        /// This method is used to get parameter by item name
        /// </summary>
        /// <param name="Name">Parameter name</param>
        /// <returns>Selected HCI parameter class</returns>
        ...
        /// <summary>
        /// Reallocate array parameter by array size of "ArrayIndicator" parameter.
        /// </summary>
        /// <param name="Para">ArrayIndicator paramter in this collection</param>
        /// <param name="PrvSize">Previous array size</param>
        /// <param name="NewSize">New array size</param>
        public void ReallocateArray(Parameter Para, int PrvSize, int NewSize)
        {
            for (int i = 0; i < ParaList.Count - 1; i++)
            {
                if (ParaList[i] == Para)
                {
                    if (NewSize < PrvSize)
                    {
                        ParaList.RemoveRange(i + 1 + Para.ArrayDepth * NewSize, Para.ArrayDepth * (PrvSize - NewSize));
                        // i = ArrayIndicator index
                        // + 1 = First ArrayData index
                    }
                    else if (NewSize < PrvSize)
                    {
                        Parameter[] tmpAry = new Parameter[Para.ArrayDepth * (NewSize - PrvSize)];
                        for (int j = 0; j < tmpAry.Length; j++)
                            tmpAry[j] = ParaList[i + 1 + (j / Para.ArrayDepth)].Clone(false);
                        ParaList.InsertRange(i + 1 + Para.ArrayDepth * PrvSize, tmpAry);
                    }
                    break;
                }
            }
        ...
        /// <summary>
        /// Resize parameter data by data of "ResizableIndicator" parameter.
        /// </summary>
        /// <param name="Para">ResizableIndicator paramter in this collection</param>
        /// <param name="NewSize">New data size</param>
        public void ResizeData(Parameter Para, int NewSize)
        {
            for (int i = 0; i < ParaList.Count - 1; i++)
            {
                if (ParaList[i] == Para)
                    ParaList[i + 1].Size = NewSize;
            }
        }
        #endregion
    }
    ...
    {
        #region Variable and properties declaration
        /// <summary>Gets command name</summary>
        public string Name { get; }
        /// <summary>Gets command description</summary>
        public string Description { get; }
        /// <summary>Gets OpCode</summary>
        public short OpCode { get { return (short)((OGF << 10) | OCF); } }
        /// <summary>Gets OpCode Group Filed (Upper 6bits)</summary>
        public int OGF { get; }
        /// <summary>Gets OpCode Command Field (lower 10bits)</summary>
        public int OCF { get; }
        /// <summary>Gets or sets command parameters</summary>
        public ParameterCollection CommandParameters { get; set; }
        /// <summary>Gets or sets return parameters</summary>
        public ParameterCollection ReturnParameters { get; set; }
        /// <summary>Gets or sets command paramters tree node</summary>
        public TreeNode CommandNode { get; set; }
        /// <summary>Gets or sets return paramters tree node</summary>
        public TreeNode ReturnNode { get; set; }
        /// <summary>Send HCI command (UART or USB hearder + OpCode + Length + Command parameters)</summary>
        public WriteCommand SendCommand = null;
        /// <summary>Gets or sets the command complete event status text</summary>
        public string StatusText { get; set; }
        /// <summary>Gets or sets the status text color</summary>
        public Color StatusTextColor { get; set; }
        #endregion

        #region Construntor and destructor
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="Name">HCI command name</param>
        /// <param name="OGF">OpCode group field</param>
        /// <param name="OCF">OpCode command field</param>
        /// <param name="Description">HCI command description</param>
        public Command(string Name, int OGF, int OCF, string Description = "")
        {
            CommandNode = new TreeNode(Name + " [0x" + OCF.ToString("X3") + "]");
            CommandNode.ToolTipText = Description;
            ReturnNode = new TreeNode("Ret:" + Name + " [0x" + OCF.ToString("X3") + "]");
            this.Name = Name;
            this.OGF = OGF;
            this.OCF = OCF;
            this.Description = Description;
            StatusText = "No return data";
            StatusTextColor = Color.Black;

            CommandParameters = new ParameterCollection(CommandNode.Nodes);
            ReturnParameters = new ParameterCollection(ReturnNode.Nodes);
        }
        #endregion

        #region Command control methods
        /// <summary>
        /// Gets the HCI command packet(Vol.2, Part E, 5.4.1 : OpCode + Length + Command parameters).
        /// </summary>
        /// <param name="UsedUSB">If true, USB only, If false, UART only</param>
        /// <returns>HCI command packet</returns>
        public byte[] GetCommandPacket(bool UsedUSB = true)
        {
            List<byte> Packet = new List<byte>();
            if (!UsedUSB)
                Packet.Add((byte)PacketType.HCI_Command_Packet);
            Packet.Add((byte)(OpCode & 0xff));
            Packet.Add((byte)(OpCode >> 8));
            Packet.Add((byte)(CommandParameters.TotalLength));
            foreach (Parameter Para in CommandParameters)
                foreach (byte b in Para.Data)
                    Packet.Add(b);

            return Packet.ToArray();
        }
        /// <summary>
        /// Sets the return parameters of HCI command.
        /// </summary>
        /// <param name="DataBuffer">Received command complete evnet packet</param>
        /// <param name="StartIndex">Starting index of data buffer that is to be stored</param>
        /// <param name="Length">Command compelete event packet length</param>
        /// <returns>Return value = StartIndex + Used data length</returns>
        public int SetReturnParameters(byte[] DataBuffer, int StartIndex, int Length)
        {
            int Index = StartIndex;
            foreach (Parameter Para in ReturnParameters)
                Index = Para.SetData(DataBuffer, Index);

            if (DataBuffer.Length < Length)
            {
                StatusText = "Received size < packet length";
                StatusTextColor = Color.Tomato;
            }
            else if (ReturnParameters.TotalLength + 2 + 1 < Length)
            {
                StatusText = "Parameters size < packet length";
                StatusTextColor = Color.Tomato;
            }
            else if (ReturnParameters.TotalLength + 2 + 1 > Length)
            {
        ...
        /// <summary>
        /// Send HCI command (UART or USB hearder + OpCode + Length + Command parameters)
        /// </summary>
        /// <returns>If true, Succeed to send the HCI command</returns>
        public bool Send()
        {
            bool Status = false;
            if (SendCommand != null)
        ...
        /// Make clone class.
        /// </summary>
        /// <returns>Clone command class</returns>
        public Command Clone()
        {
            ...
            foreach (Parameter Para in CommandParameters)
                temp.CommandParameters.Add(Para.Clone());

            // Copies return parameters
            temp.ReturnParameters = new ParameterCollection(temp.ReturnParameters.Nodes);
            foreach (Parameter Para in ReturnParameters)
                temp.ReturnParameters.Add(Para.Clone());
    ...
    public class CommandCollection : IEnumerator, IEnumerable
    {
        ...
        /// <summary>Gets the number of command in this command collection</summary>
        public int Count { get { return this.CommandList.Count; } }
        private TreeNodeCollection CommandNodes = null;
        /// <summary>Get commands tree nodes </summary>
        public TreeNodeCollection TreeNodes { get { return this.CommandNodes; } }
        #endregion
        ...
        /// Constructor
        /// </summary>
        /// <param name="OGF">OpCode group field (6 bits)</param>
        /// <param name="Nodes">Commands tree node collection</param>
        ...
        #region indexer interface functions
        private int Location = -1;
        /// <summary>
        /// Gets or sets commands at the indexed location in this collection
        /// </summary>
        /// <param name="Index">location index in this collection</param>
        /// <returns></returns>
        ...
        /// Gets data at current location in this collection
        /// </summary>
        public object Current { get { return CommandList[Location]; } }
        /// <summary>
        /// Move next location. If location is over array length, loaction is set by -1.
        /// </summary>
        /// <returns>true is succeed to move, false is failed to move and reset location</returns>
        ...
        #region Command collection control functions
        /// <summary>
        /// This method is used to add the HCI command class to this collection.
        /// </summary>
        /// <param name="Name">Command Name</param>
        /// <param name="OCF">OpCode command field (10 bits)</param>
        /// <param name="Description">Command description</param>
        /// <returns>Added command class</returns>
        public Command Add(string Name, int OCF, string Description)
        {
            Command Cmd = new Command(Name, OGF, OCF, Description);
            CommandList.Add(Cmd);
        ...
        /// This method is used to add the HCI command class to this collection.
        /// </summary>
        /// <param name="Cmd">Command class</param>
        /// <returns>Added command class</returns>
        ...
        /// <summary>
        /// This method is used to insert the HCI command to this collection
        /// </summary>
        /// <param name="Index">Command index to be inserted</param>
        ...
        /// <summary>
        /// This method is used to delete the HCI command from this collection.
        /// </summary>
        ...
        /// This method is used to delete the HCI command from this collection.
        /// </summary>
        /// <param name="OCF">Command's OpCode command field</param>
        public void Remove(int OCF)
        {
            for (int i = 0; i < CommandList.Count; i++)
            {
                if (CommandList[i].OCF == OCF)
                {
                    CommandList.RemoveAt(i);
                    CommandNodes.RemoveAt(i);
                    break;
        ...
        /// <summary>
        /// This method is used to clear all HCI commands
        /// </summary>
        public void Clear()
        {
        ...
        /// <summary>
        /// This method is used to get the command class in this collection by name.
        /// </summary>
        /// <param name="Name">HCI command name</param>
        /// <returns>Selected HCI command class</returns>
        ...
        /// <summary>
        /// This method is used to get command class in this collection by OpCode.
        /// </summary>
        /// <param name="OpCode">Command OpCode</param>
        /// <returns>Selected HCI command class</returns>
        ...
        /// <summary>
        /// This method is used to get command class in this collection by OCF.
        /// </summary>
        /// <param name="OCF">Command's OpCode command field</param>
        /// <returns>Selected HCI command class</returns>
        public Command GetCommand(int OCF)
        {
            foreach (Command Cmd in CommandList)
                if (Cmd.OCF == OCF)
                    return Cmd;
    ...
    {
        #region Variable and properties declaration
        /// <summary>Gets the command group name</summary>
        public string Name { get; }
        /// <summary>Gets the OpCode group field</summary>
        public int OGF { get; }
        /// <summary>Gets or sets HCI commands</summary>
        public CommandCollection Commands { get; set; }
        /// <summary>Command group tree node</summary>
        public TreeNode Node { get; set; }
        #endregion
        ...
        /// Constructor
        /// </summary>
        /// <param name="Name">Command group name</param>
        /// <param name="OGF">OpCode group field. OpCode upper 6bits.</param>
        public CommandGroup(string Name, int OGF)
        {
            this.Name = Name;
            this.OGF = OGF;
            this.Node = new TreeNode(Name);
            this.Commands = new CommandCollection(OGF, Node.Nodes);
        }
        #endregion
    }
    /// <summary>
    /// HCI event collection class
    /// </summary>
    public class CommandGroupCollection : IEnumerator, IEnumerable
    {
        #region Variable and properties declaration
        private List<CommandGroup> CommandGroupList = null;
        /// <summary>Gets the number of command in this command collection</summary>
        public int Count { get { return this.CommandGroupList.Count; } }
        private TreeNodeCollection CommandGroupNodes = null;
        /// <summary>Get commands tree nodes </summary>
        public TreeNodeCollection TreeNodes { get { return this.CommandGroupNodes; } }
        #endregion
        ...
        /// Constructor
        /// </summary>
        public CommandGroupCollection()
        {
            CommandGroupList = new List<CommandGroup>();
        }
        #endregion
        ...
        private int Location = -1;
        /// <summary>
        /// Gets or sets event at the indexed location in this collection
        /// </summary>
        /// <param name="Index">location index in this collection</param>
        /// <returns></returns>
        public CommandGroup this[int Index]
        {
            get { return CommandGroupList[Index]; }
            set { CommandGroupList[Index] = value; }
        }
        /// <summary>
        /// Reset location. location is -1
        /// </summary>
        ...
        /// Gets data at current location in this collection
        /// </summary>
        public object Current { get { return CommandGroupList[Location]; } }
        /// <summary>
        /// Move next location. If location is over array length, loaction is set by -1.
        /// </summary>
        /// <returns>true is succeed to move, false is failed to move and reset location</returns>
        public bool MoveNext()
        {
            if (Location == (CommandGroupList.Count - 1))
            {
                Reset();
                return false;
            }
            Location++;
            return (Location < CommandGroupList.Count);
        }
        /// <summary>
        /// Return enumerator for array
        /// </summary>
        ...
        public System.Collections.IEnumerator GetEnumerator()
        {
            foreach (var reg in CommandGroupList)
            {
                yield return reg;
            }
        }
        ...
        #region Command collection control functions
        /// <summary>
        /// This method is used to add HCI command group class to this collection.
        /// </summary>
        /// <param name="Name">Command group name</param>
        /// <param name="OGF">OpCode group field. OpCode upper 6bits.</param>
        /// <returns>Added command group class</returns>
        public CommandGroup Add(string Name, int OGF)
        {
            CommandGroup CmdGroup = new CommandGroup(Name, OGF);
            CommandGroupList.Add(CmdGroup);

            return CmdGroup;
        }
        /// <summary>
        /// This method is used to delete HCI command group from this collection.
        /// </summary>
        /// <param name="Name">Command group name</param>
        public void Remove(string Name)
        {
            ...
            {
                if (CommandGroupList[i].Name == Name)
                {
        ...
        public void RemoveAt(int Index)
        {
            if ((Index >= 0) && (Index < CommandGroupList.Count))
                CommandGroupList.RemoveAt(Index);
        }
        /// <summary>
        /// This method is used to clear all HCI commands group
        /// </summary>
        public void Clear()
        {
            CommandGroupList.Clear();
        }
        /// <summary>
        /// This method is used to get command group class in this collection by name.
        /// </summary>
        /// <param name="Name">Command group name</param>
        /// <returns>Selected HCI command group class</returns>
        public Command GetCommand(string Name)
        {
            Command Cmd = null;

            foreach(CommandGroup CmdGroup in CommandGroupList)
            {
                Cmd = CmdGroup.Commands.GetCommand(Name);
                if (Cmd != null)
                    break;
            }
            return Cmd;
        ...
        /// <summary>
        /// This method is used to get command group class in this collection by OGF.
        /// </summary>
        /// <param name="OpCode">HCI OpCode</param>
        /// <returns>Selcted HCI command group class</returns>
        public Command GetCommand(short OpCode)
        {
            Command Cmd = null;
            ...
            foreach (CommandGroup CmdGroup in CommandGroupList)
            {
                Cmd = CmdGroup.Commands.GetCommand(OpCode);
                if (Cmd != null)
                    break;
            }
            return Cmd;
        ...
        /// <summary>
        /// HCI commands tree node is added to HCI command tree view.
        /// </summary>
        /// <param name="Node">Node of tree view form</param>
        public void SetTreeNodes(TreeNode Node)
        {
            foreach (CommandGroup CmdGroup in CommandGroupList)
                Node.Nodes.Add(CmdGroup.Node);
        }
        #endregion
    }
    #endregion

    #region HCI event management classes
    /// <summary>
    /// Event class
    /// </summary>
    public class Event
    {
        #region Variable and properties declaration
        /// <summary>Gets HCI event name</summary>
        public string Name { get; }
        /// <summary>Gets HCI event description</summary>
        public string Description { get; }
        /// <summary>Gets HCI event code</summary>
        public byte EventCode { get; }
        /// <summary>Gets HCI sub-event code(If zero, ther is no sub-event)</summary>
        public byte SubeventCode { get; }
        /// <summary>Gets or sets event parameters</summary>
        ...
        /// <param name="SubEventCode">Sub-event code</param>
        public Event(string Name, byte EventCode, string Description = "", byte SubEventCode = 0)
        {
            this.Name = Name;
        ...
        /// <summary>
        /// Sets the event parameters(EventCode(1B) + Length(1B) + Event parameters).
        /// </summary>
        /// <param name="DataBuffer">Received event packet buffer</param>
        /// <param name="StartIndex">Starting index of data buffer that is to be stored</param>
        /// <param name="Length">Event packet length</param>
        /// <returns>Return value = StartIndex + Used data length</returns>
        public int SetParameters(byte[] DataBuffer, int StartIndex, int Length)
        {
            int Index = StartIndex;
            ...
            else if (Parameters.TotalLength + 1 + 1 < Length)
            {
                StatusText = "Parameters size < packet length";
                StatusTextColor = Color.Tomato;
            }
    ...
    public class EventCollection : IEnumerator, IEnumerable
    {
        ...
        /// <summary>Gets the number of command in this command collection</summary>
        public int Count { get { return this.EventList.Count; } }
        #endregion
        ...
        /// Gets data at current location in this collection
        /// </summary>
        public object Current { get { return EventList[Location]; } }
        /// <summary>
        /// Move next location. If location is over array length, loaction is set by -1.
        /// </summary>
        /// <returns>true is succeed to move, false is failed to move and reset location</returns>
        ...
        #region Event collection control functions
        /// <summary>
        /// This method is used to add the HCI event class to this collection.
        /// </summary>
        /// <param name="Name">Event name</param>
        /// <param name="EventCode">Event code</param>
        /// <param name="SubEventCode">Sub-event code</param>
        /// <param name="Description">Event description</param>
        /// <returns>Added event class</returns>
        public Event Add(string Name, byte EventCode, byte SubEventCode = 0, string Description = "")
        {
            Event Evt = new Event(Name, EventCode, Description, SubEventCode);
            EventList.Add(Evt);

            return Evt;
        }
        /// <summary>
        /// This method is used to delete the HCI event from this collection.
        /// </summary>
        /// <param name="Name">Event name</param>
        public void Remove(string Name)
        {
        ...
        /// <summary>
        /// This method is used to clear all HCI events.
        /// </summary>
        public void Clear()
        {
            EventList.Clear();
        ...
        /// <summary>
        /// This method is used to get the HCI event class in this collection by name.
        /// </summary>
        /// <param name="Name">HCI event name</param>
        /// <returns>Selected event class</returns>
        ...
        /// <summary>
        /// This method is used to get the HCI event class in this collection by event type
        /// </summary>
        /// <param name="EventCode">Event code</param>
        /// <param name="SubeventCode">Sub-event code</param>
        /// <returns>Selected event class</returns>
        public Event GetEvent(byte EventCode, byte SubeventCode = 0)
        {
            foreach (Event Evt in EventList)
                if ((Evt.EventCode == EventCode) && (Evt.SubeventCode == SubeventCode))
                    return Evt;
            return null;
        }
        #endregion
    ...
    #region HCI mangement class
    /// <summary>
    /// HCI management class
    /// </summary>
    public class HCIManager
    {
        #region Variable and properties declaration
        private bool Opened = false;
        /// <summary>Gets the connection status. If true, Connected</summary>
        public bool IsOpen { get { return Opened; } }

        /// <summary>Gets the link layer statue</summary>
        public LinkLayerState LLStatus { get; }
        /// <summary>Gets or sets the HCI command groups</summary>
        public CommandGroupCollection CommandGroups { get; set; }
        /// <summary>Gets or sets the HCI events</summary>
        public EventCollection Events { get; set; }
        
        /// <summary>Get or sets the HCI command tree view</summary>
        public TreeView CommandTree { get; set; }
        /// <summary>Gets or sets the log of the HCI commands and events</summary>
        public DataGridView LogView { get; set; }
        /// <summary>Gets or sets the log of scan results</summary>
        public DataGridView ScanLogView { get; set; }
        /// <summary>Gets HCI log</summary>
        public DataTable Log { get; }
        /// <summary>Gets or sets the HCI parameter DataGridView for editing data</summary>
        public DataGridView ParaView { get; set; }
        /// <summary>Gets or sets the HCI parameter name label</summary>
        public Label ParaLabel { get; set; }
        #endregion
        ...
        public HCIManager()
        {
            LLStatus = LinkLayerState.Unknown;
        ...
        #region Communication control methods

        #region Private variable declaration
        private System.IO.Ports.SerialPort UART = null;
        private LibUsbDotNet.UsbDevice USB = null;
        private List<LibUsbDotNet.Main.UsbRegistry> UsbDevices = new List<LibUsbDotNet.Main.UsbRegistry>();
        private LibUsbDotNet.UsbEndpointReader UsbEventReader; // HCI event reader.(Endpoint = 0x81, Interrupt(IN))
        private LibUsbDotNet.UsbEndpointWriter UsbAclDataWriter; // ACL data writer.(Endpoint = 0x02, Bulk(OUT))
        private LibUsbDotNet.UsbEndpointReader UsbAclDataReader; // ACL data reader.(Endpoint = 0x82, Bulk(IN))
        /* USB isochronous interface types are had some alternate ID. */
        private List<LibUsbDotNet.UsbEndpointWriter> UsbIsochWriter = new List<LibUsbDotNet.UsbEndpointWriter>(); // Isochronous writer.(Endpoint = 0x03, Isochronous(OUT))
        private List<LibUsbDotNet.UsbEndpointReader> UsbIsochReader = new List<LibUsbDotNet.UsbEndpointReader>(); // Isochronous reader.(Endpoint = 0x83, Isochronous(IN))

        private ComnType CurComnType = ComnType.None; // Current connected communication type
        private Queue RcvQueue = new Queue(65536 + 256);
        private int NumUsbEventRemainderBytes = 0;
        private int NumUsbAclDataRemainderBytes = 0;

        private System.Threading.Thread RcvMessageHandler;
        private ManualResetEvent HCIResetEvent = new ManualResetEvent(true);
        private volatile bool IsEventHandling = false;
        private PacketType CurPacketType = PacketType.HCI_No_Packet; // For HCI received packet
        private uint PayloadLength = uint.MaxValue; // For HCI received packet
        private byte EventCode = 0; // For HCI event
        private byte SubeventCode = 0; // For HCI event
        private short ACLHandle = 0; // For ACL data
        private byte PacketBoudaryFlag = 0;  // For ACL data
        private byte BrodcastFlag = 0;  // For ACL data
        private short ConnectionHandle = 0; // For Synchronous data
        private byte PacketStatusFlag = 0; // For Synchronous data
        #endregion

        #region Search UART ports or USB device
        /// <summary>
        /// This method is used to search for available serial ports.
        /// </summary>
        /// <returns>Available serial ports names</returns>
        ...
        /// This method is used to search for available serial ports.
        /// </summary>
        /// <returns>Available USB devices names</returns>
        public string[] SearchUsbDevices()
        {
            ...
            /*
            foreach (LibUsbDotNet.Main.UsbRegistry Registry in LibUsbDotNet.UsbDevice.AllDevices)
            {
                if (Registry.Device != null)
                {
                    if (Registry.Device.DriverMode == LibUsbDotNet.UsbDevice.DriverModeType.LibUsb)
                    {
                        Console.WriteLine(Registry.ToString());
                        ValidDevices.Add(Registry.Name);
                        UsbDevices.Add(Registry);
                    }
                }
            }
            */
        ...
        /// </summary>
        /// <param name="PortName">Port name(eg. "COM1", "COM3"). It is return values of "SearchSerialPort()"</param>
        /// <param name="BaudRate">Baud rate</param>
        /// <returns>Connection status(true is open)</returns>
        ...
        /// <summary>
        /// Opens an USB device connection.
        /// </summary>
        /// <param name="DeviceIndex">Device index of the return values of "SearchUsbDevices()"</param>
        /// <returns>Connection status(true is open)</returns>
        public bool OpenUSB(int DeviceIndex)
        {
            if (Opened) return IsOpen;
                ...
                foreach (LibUsbDotNet.Info.UsbConfigInfo Config in USB.Configs)
                {
                    ...
                    foreach (LibUsbDotNet.Info.UsbInterfaceInfo Interface in Config.InterfaceInfoList)
                    {
                        ...
                        foreach (LibUsbDotNet.Info.UsbEndpointInfo Endpoint in Interface.EndpointInfoList)
                        {
                            ...
                            {
                                // USB max data size = 8192
                                if (Endpoint.Descriptor.EndpointID == 0x81) // 0x81 is endpoint address of HCI event
                                {
                                ...
                                else if (Endpoint.Descriptor.EndpointID == 0x82) // 0x82 is endpoint address of ACL data read
                                {
                                    UsbAclDataReader = USB.OpenEndpointReader(ReadEndpointID.Ep02, 1024, EndpointType.Bulk);
                                    UsbAclDataReader.DataReceivedEnabled = true;
                                    UsbAclDataReader.DataReceived += UsbAclDataReader_DataReceived;
                                    UsbAclDataReader.ReadThreadPriority = ThreadPriority.Normal;
                                }
                                else if (Endpoint.Descriptor.EndpointID == 0x02) // 0x02 is endpoint address of ACL data write
                                    UsbAclDataWriter = USB.OpenEndpointWriter(WriteEndpointID.Ep02, EndpointType.Bulk);
                            }
                            else if (Interface.Descriptor.InterfaceID == 1)
                            {
                                if (Endpoint.Descriptor.EndpointID == 0x83) // 0x83 is endpoint address of Isochronous data read
                                {
                                ...
                                else if (Endpoint.Descriptor.EndpointID == 0x03) // 0x02 is endpoint address of ACL data write
                                {
        ...
        /// <summary>
        /// Closes the USB device or serial connection.
        /// </summary>
        /// <returns>Connection status(false is closing)</returns>
        public bool Close()
        {
            if (Opened)
            {
        ...
        #region Sending control methods
        private bool SendCommand(Command Cmd)
        {
            ...
            if (CurComnType == ComnType.USB)
            {
                BytesToSend = Cmd.GetCommandPacket(true); // Gets HCI command packet for USB
                UsbSetupPacket UsbSetupPck = new UsbSetupPacket(0x20, 0x00, 0x00, 0x00, (short)BytesToSend.Length);
                Status = USB.ControlTransfer(ref UsbSetupPck, BytesToSend, BytesToSend.Length, out int Length);
            }
            else if (CurComnType == ComnType.Serial)
            {
                BytesToSend = Cmd.GetCommandPacket(false); // Gets HCI command packet for UART
                UART.Write(BytesToSend, 0, BytesToSend.Length);
                Status = true;
            }
            /* Create a log of the transmitted HCI command */
            if (Status)
            {
                SetCommandLog(Cmd);
            }
        ...
        #region Received event control methods
        ...
        private void UART_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            /* Store received data to reception queue */
            RcvQueue.SetBytes(RcvBytes, 0, NumBytesToRead);

            HCIResetEvent.Set(); // Set signal for reception complete
        }
        ...
        private void UsbEventReader_DataReceived(object sender, EndpointDataEventArgs e)
        {
            ...
            /* Add packet indicator. Because It makes to same form USB packet format to UART packet format. */
            if (NumUsbEventRemainderBytes == 0)
            {
                RcvQueue.SetByte((byte)PacketType.HCI_Event_Packet);
                /* e.Buffer[0] = 1 byte event code, e.Buffer[1] = 1 byte event packet length */
                if (e.Buffer[1] > (e.Count - 2))
                    NumUsbEventRemainderBytes = e.Buffer[1] - (e.Count - 2);
            }
            else
            {
                if (NumUsbEventRemainderBytes <= e.Count)
                    NumUsbEventRemainderBytes = 0;
                else
                    NumUsbEventRemainderBytes -= e.Count;
            }
            /* Store received data to reception queue */
            RcvQueue.SetBytes(e.Buffer, 0, e.Count);

            HCIResetEvent.Set(); // Set signal for reception complete
        }

        private void UsbAclDataReader_DataReceived(object sender, EndpointDataEventArgs e)
        {
            if ((USB == null) || !IsOpen)
                return;

            /* Add packet indicator. Because It makes to same form USB packet format to UART packet format. */
            if (NumUsbAclDataRemainderBytes == 0)
            {
                RcvQueue.SetByte((byte)PacketType.HCI_ACL_Data_Packet);
                /* e.Buffer[0] = 1 byte event code, e.Buffer[1] = 1 byte event packet length */
                if (e.Buffer[1] > (e.Count - 2))
                    NumUsbAclDataRemainderBytes = e.Buffer[1] - (e.Count - 2);
            }
            else
            {
                if (NumUsbAclDataRemainderBytes <= e.Count)
                    NumUsbAclDataRemainderBytes = 0;
                else
                    NumUsbAclDataRemainderBytes -= e.Count;
            }
            /* Store received data to reception queue */
            RcvQueue.SetBytes(e.Buffer, 0, e.Count);
        ...
        #region Reception thread control methods

        private void RunRcvThread()
        {
            ResetPacketInfo();

            IsEventHandling = true;
            RcvMessageHandler = new System.Threading.Thread(RcvMessageHandler_DoWork);
            RcvMessageHandler.IsBackground = true;
            RcvMessageHandler.Start();

            while (!RcvMessageHandler.IsAlive) ;
        }

        private void StopRcvThread()
        {
            IsEventHandling = false;
            RcvMessageHandler.Join();
            RcvMessageHandler = null;
        }

        private void ResetPacketInfo()
        {
            CurPacketType = PacketType.HCI_No_Packet; // For HCI received packet
            PayloadLength = uint.MaxValue; // For HCI received packet
            EventCode = 0; // For HCI event
            SubeventCode = 0; // For HCI event
            ACLHandle = 0; // For ACL data
            PacketBoudaryFlag = 0;  // For ACL data
            BrodcastFlag = 0;  // For ACL data
            ConnectionHandle = 0; // For Synchronous data
            PacketStatusFlag = 0; // For Synchronous data
        }

        private const int MaxDelayCount = 5;
        private void RcvMessageHandler_DoWork()
        {
            int DelayCount = 0;
            ...
            while (IsEventHandling)
            {
                if (RcvQueue.Count > 0)
                {
                    if (CurPacketType == PacketType.HCI_No_Packet)
                        CurPacketType = (PacketType)RcvQueue.GetByte();

                    switch (CurPacketType)
                    {
                        case PacketType.HCI_Event_Packet:
                            if (HandleEventPacket() == false)
                                DelayCount++;
                            break;
                        case PacketType.HCI_ACL_Data_Packet:
                            if (HandleEventPacket() == false)
                                DelayCount++;
                            break;
                        case PacketType.HCI_Synchronous_Data_Packet:
                            if (HandleSynchronousDataPacket() == false)
                                DelayCount++;
                            break;

                        /* When received packet can not be handled */
                        case PacketType.HCI_Command_Packet:
                        default:
                            DelayCount = MaxDelayCount;
                            break;
                    }
                    if (DelayCount == MaxDelayCount) // Failed to receive packet
                    {
                        RcvQueue.Clear();
                        ResetPacketInfo();
                    }
                    else // Wait for receiving the remainder packet
        ...
        #region HCI received packet handling methods

        private bool HandleEventPacket()
        {
            Event HciEvent = null;
            Command HciCommand = null;
            int StartIndex = 0;

            /* Gets HCI event header (1byte event code + 1byte payload length) */
            if ((RcvQueue.Count >= 2) && (PayloadLength == uint.MaxValue))
            {
                EventCode = RcvQueue.GetByte();
                PayloadLength = RcvQueue.GetByte();
            }
            /* Sets HCI event parameters */
            if (PayloadLength <= RcvQueue.Count)
            {
                // Gets event payload
                byte[] Packet = RcvQueue.GetBytes((int)PayloadLength);
                StartIndex = 0;

                // Sets HCI event parameters
                switch ((EventCodes)EventCode)
                {
                    case EventCodes.Command_Complete_Event:
                        HciEvent = Events.GetEvent(EventCode);
                        if (HciEvent != null)
                        {
                            // Sets command complete event paramters without HCI command return parameters
                            StartIndex = HciEvent.SetParameters(Packet, StartIndex, HciEvent.Parameters.TotalLength);
                            // Sets HCI command return parameters
                            short OpCode = (short)((HciEvent.Parameters[1].Data[1] << 8) | HciEvent.Parameters[1].Data[0]);
                            HciCommand = CommandGroups.GetCommand(OpCode);
                            if (HciCommand != null)
                                HciCommand.SetReturnParameters(Packet, StartIndex, HciCommand.ReturnParameters.TotalLength);
                        }
                        break;
                    case EventCodes.LE_Meta_Event:
                        SubeventCode = Packet[0]; // First LE Meta Event parameter is sub-event code.
                        HciEvent = Events.GetEvent(EventCode, SubeventCode);
                        HciEvent.SetParameters(Packet, StartIndex, HciEvent.Parameters.TotalLength);
                        break;
                ...
                ResetPacketInfo(); // Reset packet information for packet handling
        ...
        private bool HandleAclDataPacket()
        {
            /* Gets ACL Data header (12bits ACL Handle + 2bits PB flag + 2bits BC flag + 2bytes payload length) */
            if ((RcvQueue.Count >= 4) && (PayloadLength == uint.MaxValue))
            {
                ConnectionHandle = RcvQueue.GetShort();
                PayloadLength = (uint)RcvQueue.GetShort();
                PacketStatusFlag = (byte)((ConnectionHandle >> 12) & 0x3);
            ...
            if (PayloadLength <= RcvQueue.Count)
            {
                ...
                /*
                 * TBD : Must be create code for the synchronous data packet handling
                 * */
        ...
        private bool HandleSynchronousDataPacket()
        {
            /* Gets synchronous data header (12bits Connection Handle + 2bits Packet status flag + 2bits RFU + 1byte payload length) */
            if ((RcvQueue.Count >= 4) && (PayloadLength == uint.MaxValue))
            {
                ACLHandle = RcvQueue.GetShort();
                PayloadLength = (uint)RcvQueue.GetByte();
            ...
            if (PayloadLength <= RcvQueue.Count)
            {
                ...
                /*
                 * TBD : Must be create code for the ACL data packet handling
                 * */
        ...
        #endregion // Communication control methods

        #region GUI control methods

        #region HCI command tree view conatrol and events methods

        private CommandGroup SelectedCommandGroup;
        private Command SelectedCommand;
        private Parameter SelectedParameter;

        /// <summary>
        /// Initialize HCI command tree view
        /// </summary>
        /// <param name="CommandTree"></param>
        public void InitCommandTreeView(TreeView CommandTree)
        {
            if (CommandTree == null)
                return;

            foreach (CommandGroup cg in CommandGroups)
                CommandTree.Nodes.Add(cg.Node);

            CommandTree.ShowNodeToolTips = true;
        ...
        private void CommandTree_AfterSelect(object sender, TreeViewEventArgs e)
        {
            switch (e.Node.Level)
            {
                case 0: // Top node (HCI command group)
                    SelectedCommandGroup = CommandGroups[e.Node.Index];
                    SelectedCommand = null;
                    SelectedParameter = null;
                    break;
                case 1: // 2nd node (HCI command)
                    SelectedCommandGroup = CommandGroups[e.Node.Parent.Index];
                    SelectedCommand = SelectedCommandGroup.Commands[e.Node.Index];
                    SelectedParameter = null;
                    break;
                case 2: // 3rd node (HCI command parameter)
                    SelectedCommandGroup = CommandGroups[e.Node.Parent.Parent.Index];
                    SelectedCommand = SelectedCommandGroup.Commands[e.Node.Parent.Index];
                    SelectedParameter = SelectedCommand.CommandParameters[e.Node.Index];
                    break;
                default:
        ...
        #region HCI command parameter data grid view control and events methods
        /// <summary>
        /// Initialize HCI command parameter GUI for editing data
        /// </summary>
        /// <param name="ParaView">Parameter data editing form</param>
        /// <param name="ParaLabel">Parameter name display form</param>
        public void InitParameterGridView(DataGridView ParaView, Label ParaLabel)
        {
            if (ParaView != null)
            {
                ...
                ParaView.AllowUserToAddRows = false;
                ParaView.AllowUserToDeleteRows = false;
                ParaView.AllowUserToResizeColumns = false;
                ParaView.AllowUserToResizeRows = false;
                ParaView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;

                cs1.Alignment = System.Windows.Forms.DataGridViewContentAlignment.BottomCenter;
                cs1.BackColor = System.Drawing.SystemColors.Control;
                cs1.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                ...
                ParaView.ColumnHeadersDefaultCellStyle = cs1;
                ParaView.ColumnHeadersHeight = 21;
                ParaView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
                ParaView.RowHeadersVisible = false;

                cs2.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                ParaView.RowsDefaultCellStyle = cs2;
                ParaView.RowTemplate.DefaultCellStyle.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                ParaView.RowTemplate.Height = 17;

                ParaView.CellEndEdit += ParaView_CellEndEdit;
        ...
        private void ParaView_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            byte Data = 0;
            ...
            int Index = SelectedParameter.Size - 1 - e.ColumnIndex;
            
            /* Gets parameter data */
            try
            {
                // Gets new data
                Data = (byte)int.Parse(ParaView.Rows[e.RowIndex].Cells[e.ColumnIndex].ToString(), System.Globalization.NumberStyles.HexNumber);
            }
            catch
            {
                // Gets previous data
                Data = SelectedParameter.Data[Index];
            }
            /* Sets parameter data */
            finally
            {
                if (SelectedParameter.Data[Index] == Data)
                    ParaView.Rows[e.RowIndex].Cells[e.ColumnIndex].Value = Data.ToString("X2");
                else
                    SelectedParameter.Data[Index] = Data;
            }
        }
        /// <summary>
        /// Sets HCI command parameter to parameter data grid view
        /// </summary>
        /// <param name="Para">HCI command parameter</param>
        public void SetParameter(Parameter Para)
        {
            /* Set paramter data grid view */
            if (ParaView != null)
            {
                /* Clear parameter grid view */
                ParaView.Rows.Clear();
                ParaView.Columns.Clear();

                if (Para != null)
                {
                    /* Add columns */
                    ParaView.ColumnCount = Para.Size;
                    for (int i = Para.Size - 1; i >= 0; i--)
                        ParaView.Columns[i].Name = "B" + i.ToString();

                    /* Add rows */
                    ParaView.Rows.Add();
                    for (int i = Para.Size - 1; i >= 0; i--)
                        ParaView.Rows[0].Cells["B" + i.ToString()].Value = Para.Data[i].ToString("X2");

                    for (int i = 0; i < Para.Size; i++)
                    {
                        ParaView.Columns[i].Width = 28;
                        ParaView.Columns[i].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                    }
                }
            }
            /* Set paramter name label */
            if (ParaLabel != null)
            {
                if (Para != null)
                    ParaLabel.Text = Para.Name;
                else
                    ParaLabel.Text = "HCI Command Parameter";
            }
        }
        #endregion

        #region Log data grid view form control and events methods
        /// <summary>
        /// Initialize HCI command and events log view
        /// </summary>
        /// <param name="LogView">It is window form to display the HCI log message. Even if it is null, HCI log message can be seen "Log" property.</param>
        public void InitLog(DataGridView LogView)
        {
            Log.Rows.Clear();
            Log.Columns.Clear();

            Log.Columns.Add("Time", typeof(string));
            Log.Columns.Add("Name", typeof(string));
            Log.Columns.Add("Info.", typeof(string));
            ...
            if (LogView == null)
            {
                ...
                LogView.AllowUserToResizeColumns = false;
                LogView.AllowUserToResizeRows = false;
                ...
                cs1.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
                cs1.WrapMode = System.Windows.Forms.DataGridViewTriState.True;
                LogView.ColumnHeadersDefaultCellStyle = cs1;
                LogView.ColumnHeadersHeight = 21;
                LogView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
                LogView.RowHeadersVisible = false;

                cs2.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                LogView.RowsDefaultCellStyle = cs2;
                LogView.RowTemplate.DefaultCellStyle.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                LogView.RowTemplate.Height = 17;

                LogView.DataSource = Log;
                for (int i = 0; i < LogView.ColumnCount; i++)
                {
                    LogView.Columns[i].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
                    LogView.Columns[i].SortMode = DataGridViewColumnSortMode.NotSortable;
                }
                LogView.Columns[0].Width = 56;
                LogView.Columns[1].Width = 170;
                LogView.Columns[2].Width = LogView.Width - 5 - LogView.Columns[0].Width - LogView.Columns[1].Width - 20;

                LogView.ShowCellToolTips = true;
                LogView.Resize += LogView_Resize;
                LogView.ColumnWidthChanged += LogView_ColumnWidthChanged;
            }
        }
        /// <summary>
        /// Clear HCI commands and events log
        /// </summary>
        ...
        {
            if (LogView.Columns.Count >= 3)
                LogView.Columns[2].Width = LogView.Width - 5 - LogView.Columns[0].Width - LogView.Columns[1].Width - 20;
        }

        private void LogView_ColumnWidthChanged(object sender, DataGridViewColumnEventArgs e)
        {
            if (LogView.Columns.Count >= 3)
                LogView.Columns[2].Width = LogView.Width - 5 - LogView.Columns[0].Width - LogView.Columns[1].Width - 20;
        }
        ...
        {
            LogView.Invoke(new MethodInvoker(delegate ()
            {
                LogView.Update();
                LogView.Refresh();
            }));
        ...
        private void SetParameterLog(ParameterCollection Parameters)
        {
            LogView.Invoke(new MethodInvoker(delegate ()
            {
                foreach (Parameter Para in Parameters)
                {
                    Log.Rows.Add("", Para.Name, Para.ToString());
                    LogView[1, LogView.RowCount - 1].Style.Alignment = DataGridViewContentAlignment.MiddleRight;
                    LogView[1, LogView.RowCount - 1].ToolTipText = Para.Name + "\n" + Para.Description;
                }
            }));
        }

        private void SetCommandLog(Command Cmd)
        {
            LogView.Invoke(new MethodInvoker(delegate ()
            {
                Log.Rows.Add(DateTime.Now.ToString("HH:mm:ss"), Cmd.Name, "OGF=0x" +
                    Cmd.OGF.ToString("X2") + ", OCF=0x" + Cmd.OCF.ToString("X2"));
                LogView[1, LogView.RowCount - 1].ToolTipText = Cmd.Name + "\n" + Cmd.Description;

                for (int c = 0; c < LogView.ColumnCount; c++)
                {
                    LogView[c, LogView.RowCount - 1].Style.ForeColor = Color.RoyalBlue;
                    LogView[c, LogView.RowCount - 1].Style.Font = new Font("Consolas", 8F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                }
                Log.Rows.Add("", "OpCode", "0x" + Cmd.OpCode.ToString("X4"));
                LogView[1, LogView.RowCount - 1].Style.Alignment = DataGridViewContentAlignment.MiddleRight;
                Log.Rows.Add("", "Payload Length", Cmd.CommandParameters.TotalLength.ToString() + " Octets");
                LogView[1, LogView.RowCount - 1].Style.Alignment = DataGridViewContentAlignment.MiddleRight;

                // Set command parameters
                SetParameterLog(Cmd.CommandParameters);

                // Mode focus
                LogView.FirstDisplayedCell = LogView[1, LogView.RowCount - 1];
            }));
        }
        #endregion

        #endregion // Log control methods

        #region HCI commands and events initialization methods

        private void InitCommands()
        {
            CommandGroups = new CommandGroupCollection();

            InitLinkControlCommands();
            InitControllerBasebandCommands();
            InitInformationalParameters();
            InitStatusParameters();
            InitLEControllerCommands();
        }

        #region Initialize HCI commands

        private void InitLinkControlCommands()
        {
            Command c;
            Parameter p;

            CommandGroups.Add("Link Control Commands", 0x01);
            CommandGroup cg = CommandGroups[CommandGroups.Count - 1];

            #region HCI_Disconnect (OCF=0x0006)
            ...
            c.SendCommand = SendCommand; // Set HCI command write methods
            /* Add HCI command parameters */
            ...
            p.SetData(new byte[] { 0x13 }, 0);
            /* Add return parameters */
            #endregion

            #region HCI_Read_Remote_Version_Information (OCF=0x001D)
        ...
        private void InitControllerBasebandCommands()
        {
            Command c;
            Parameter p;

            CommandGroups.Add("Controller & Baseband Commands", 0x03);
            CommandGroup cg = CommandGroups[CommandGroups.Count - 1];

            #region HCI_Set_Event_Mask (OCF=0x001)
            ...
            p = c.CommandParameters.Add("Event_Mask", 8, ParameterDataType.Bytes,
                "Bit00 Inquiry Complete Event\n" +
                "Bit01 Inquiry Result Event\n" +
                "Bit02 Connection Complete Event\n" +
                "Bit03 Connection Request Event\n" +
                "Bit04 Disconnection Complete Event\n" +
                "Bit05 Authentication Complete Event\n" +
                "Bit06 Remote Name Request Complete Event\n" +
                "Bit07 Encryption Change Event\n" +
                "Bit08 Change Connection Link Key Complete Event\n" +
                "Bit09 Master Link Key Complete Event\n" +
                "Bit10 Read Remote Supported Features Complete Event\n" +
                "Bit11 Read Remote Version Information Complete Event\n" +
                "Bit12 QoS Setup Complete Event\n" +
                "Bit15 Hardware Error Event\n" +
                "Bit16 Flush Occurred Event\n" +
                "Bit17 Role Change Event\n" +
                "Bit19 Mode Change Event\n" +
                "Bit20 Return Link Keys Event\n" +
                "Bit21 PIN Code Request Event\n" +
                "Bit22 Link Key Request Event\n" +
                "Bit23 Link Key Notification Event\n" +
                "Bit24 Loopback Command Event\n" +
                "Bit25 Data Buffer Overflow Event\n" +
                "Bit26 Max Slots Change Event\n" +
                "Bit27 Read Clock Offset Complete Event\n" +
                "Bit28 Connection Packet Type Changed Event\n" +
                "Bit29 QoS Violation Event\n" +
                "Bit30 Page Scan Mode Change Event[deprecated]\n" +
                "Bit31 Page Scan Repetition Mode Change Event\n" +
                "Bit32 Flow Specification Complete Event\n" +
                "Bit33 Inquiry Result with RSSI Event\n" +
                "Bit34 Read Remote Extended Features Complete Event\n" +
                "Bit43 Synchronous Connection Complete Event\n" +
                "Bit44 Synchronous Connection Changed Event\n" +
                "Bit45 Sniff Subrating Event\n" +
                "Bit46 Extended Inquiry Result Event\n" +
                "Bit47 Encryption Key Refresh Complete Event\n" +
                "Bit48 IO Capability Request Event\n" +
                "Bit49 IO Capability Request Reply Event\n" +
                "Bit50 User Confirmation Request Event\n" +
                "Bit51 User Passkey Request Event\n" +
                "Bit52 Remote OOB Data Request Event\n" +
                "Bit53 Simple Pairing Complete Event\n" +
                "Bit55 Link Supervision Timeout Changed Event\n" +
                "Bit56 Enhanced Flush Complete Event\n" +
                "Bit58 User Passkey Notification Event\n" +
                "Bit59 Keypress Notification Event\n" +
                "Bit60 Remote Host Supported Features Notification Event\n" +
                "Bit61 LE Meta Event\n" +
                "The default is for bits 0 to 44 inclusive (0x00001FFFFFFFFFFF)\n");
            p.SetData(new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x3F }, 0); // For LE events
            /* Add return parameters */
            ...
            #region HCI_Read_Local_Name (0CF=0x014)
            ...
            #region HCI_Read_Transmit_Power_Level (0CF=0x02D)
            ...
            #region HCI_Set_Controller_To_Host_Flow_Control (0CF=0x031)
            ...
            c.ReturnParameters.Add("Status", 1, ParameterDataType.Status,
                ...
                "0x01-0xFF HCI_Set_Controller_To_Host_Flow_Control command failed.");
            #endregion

            #region HCI_Host_Buffer_Size (0CF=0x033)
            ...
            #region HCI_Host_Number_Of_Completed_Packets (0CF=0x035) [Array parameter]
            ...
            c.CommandParameters.Add("Number_Of_Handles", 1, ParameterDataType.Number,
                ...
                "Range: 0 - 255",
                ParameterType.ArrayIndicator, 2);
            ...
            #region HCI_Set_Event_Mask_Page_2 (0CF=0x063)
            ...
            c.CommandParameters.Add("Event_Mask_Page_2", 8, ParameterDataType.Bytes,
                "Bit00 Physical Link Complete Event\n" +
                "Bit01 Channel Selected Event\n" +
                "Bit02 Disconnection Physical Link Event\n" +
                "Bit03 Physical Link Loss Early Warning Event\n" +
                "Bit04 Physical Link Recovery Event\n" +
                "Bit05 Logical Link Complete Event\n" +
                "Bit06 Disconnection Logical Link Complete Event\n" +
                "Bit07 Flow Spec Modify Complete Event\n" +
                "Bit08 Number of Completed Data Blocks Event\n" +
                "Bit09 AMP Start Test Event\n" +
                "Bit10 AMP Test End Event\n" +
                "Bit11 AMP Receiver Report Event\n" +
                "Bit12 Short Range Mode Change Complete Event\n" +
                "Bit13 AMP Status Change Event\n" +
                "Bit14 Triggered Clock Capture Event\n" +
                "Bit15 Synchronization Train Complete Event\n" +
                "Bit16 Synchronization Train Received Event\n" +
                "Bit17 Connectionless Slave Broadcast Receive Event\n" +
                "Bit18 Connectionless Slave Broadcast Timeout Event\n" +
                "Bit19 Truncated Page Complete Event\n" +
                "Bit20 Slave Page Response Timeout Event\n" +
                "Bit21 Connectionless Slave Broadcast Channel Map Change Event\n" +
                "Bit22 Inquiry Response Notification Event\n" +
                "Bit23 Authenticated Payload Timeout Expired Event\n" +
            ...
            #region HCI_Read_LE_Host_Support (0CF=0x06C)
            ...
            #region HCI_Write_LE_Host_Support (0CF=0x06D)
            ...
            #region HCI_Read_Authenticated_Payload_Timeout(0CF=0x07B)
            ...
            #region HCI_Write_Authenticated_Payload_Timeout(0CF=0x07C)
            ...
            p = c.CommandParameters.Add("Authenticated_Payload_Timeout", 2, ParameterDataType.Time_10msec,
                ...
                "Default = 0x0BB8(30 seconds), Range: 0x0001 to 0xFFFF\n" +
                "Time = N * 10 msec (Time Range: 10 msec to 655, 350 msec)");
            p.SetData(new byte[] { 0xB8, 0x0B }, 0);
            /* Add return parameters */
            c.ReturnParameters.Add("Status", 1, ParameterDataType.Status,
        ...
        private void InitInformationalParameters()
        {
            Command c;
            //Parameter p;

            CommandGroups.Add("Informational Parameters", 0x04);
            CommandGroup cg = CommandGroups[CommandGroups.Count - 1];

            #region HCI_Read_Local_Version_Information (OCF=0x001)
            ...
            #region HCI_Read_Local_Supported_Commands (OCF=0x002)
            ...
            #region HCI_Read_Local_Supported_Features (OCF=0x003)
            ...
            #region HCI_Read_Local_Extended_Features (OCF=0x004)
            ...
            #region HCI_Read_Buffer_Size (OCF=0x005)
            ...
            #region HCI_Read_BD_ADDR (OCF=0x009)
            ...
            #region HCI_Read_Data_Block_Size (OCF=0x00A)
            ...
            #region HCI_Read_Local_Supported_Codecs (OCF=0x00B) [Array parameter]
            ...
            c.ReturnParameters.Add("Number_of_Supported_Codecs", 1, ParameterDataType.Number,
                ...
                ParameterType.ArrayIndicator, 1);
        ...
        private void InitStatusParameters()
        {
            Command c;
            //Parameter p;

            CommandGroups.Add("Status Parameters", 0x05);
            CommandGroup cg = CommandGroups[CommandGroups.Count - 1];

            #region HCI_Read_RSSI (OCF=0x0005)
        ...
        private void InitLEControllerCommands()
        {
            Command c;
            Parameter p;

            CommandGroups.Add("LE Controller Commands", 0x08);
            CommandGroup cg = CommandGroups[CommandGroups.Count - 1];

            #region HCI_LE_Set_Event_Mask (OCF=0x0001) [Edit v5.0]
            ...
            p = c.CommandParameters.Add("LE_Event_Mask", 8, ParameterDataType.Bytes,
                "Bit00 LE Connection Complete Event\n" +
                "Bit01 LE Advertising Report Event\n" +
                "Bit02 LE Connection Update Complete Event\n" +
                "Bit03 LE Read Remote Used Features Complete Event\n" +
                "Bit04 LE Long Term Key Request Event\n" +
                "Bit05 LE Remote Connection Parameter Request Event\n" +
                "Bit06 LE Data Length Change Event\n" +
                "Bit07 LE Read Local P-256 Public Key Complete Event\n" +
                "Bit08 LE Generate DHKey Complete Event\n" +
                "Bit09 LE Enhanced Connection Complete Event\n" +
                "Bit10 LE Direct Advertising Report Event\n" +
                "Bit11 LE PHY Update Complete Event\n" +
                "Bit12 LE Extended Advertising Report Event\n" +
                "Bit13 LE Periodic Advertising Sync Established Event\n" +
                "Bit14 LE Periodic Advertising Report Event\n" +
                "Bit15 LE Periodic Advertising Sync Lost Event\n" +
                "Bit16 LE Extended Scan Timeout Event\n" +
                "Bit17 LE Extended Advertising Set Terminated Event\n" +
                "Bit18 LE Scan Request Received Event\n" +
                "Bit19 LE Channel Selection Algorithm Event\n" +
                "The default is for bits 0 to 3 incluesive (0x1F) to be set.");
            p.SetData(new byte[] { 0x1F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, 0);
            /* Add return parameters */
            c.ReturnParameters.Add("Status", 1, ParameterDataType.Status,
            ...
            #region HCI_LE_Read_Buffer_Size (OCF=0x0002)
            ...
            #region HCI_LE_Read_Local_Supported_Features (OCF=0x0003) [Edit v5.0]
            ...
            c.ReturnParameters.Add("LE_Features", 8, ParameterDataType.Bytes,
                "Bit00 LE Encryption\n" +
                "Bit01 Connection Parameters Request Procedure\n" +
                "Bit02 Extended Reject Indication\n" +
                "Bit03 Slave-initiated Features Exchange\n" +
                "Bit04 LE Ping\n" +
                "Bit05 LE Data Packet Length Extension\n" +
                "Bit06 LL Privacy\n" +
                "Bit07 Extended Scanner Filter Policies\n" +
                "Bit08 LE 2M PHY\n" +
                "Bit09 Stable Modulation Index - Transmitter\n" +
            ...
            #region HCI_LE_Set_Random_Address (OCF=0x0005)
            ...
            #region HCI_LE_Set_Advertising_Parameters (OCF=0x0006)
            ...
            p.SetData(new byte[] { 0x00, 0x08 }, 0);
            ...
            #region HCI_LE_Read_Advertising_Channel_Tx_Power (OCF=0x0007)
            ...
            #region HCI_LE_Set_Advertising_Data (OCF=0x0008)
            ...
            #region HCI_LE_Set_Scan_Response_Data (OCF=0x0009)
            ...
            #region HCI_LE_Set_Advertising_Enable (OCF=0x000A)
            ...
            #region HCI_LE_Set_Scan_Parameters (OCF=0x000B)
            ...
            p.SetData(new byte[] { 0x10, 0x00 }, 0); // 10msec
            ...
            #region HCI_LE_Set_Scan_Enable (OCF=0x000C)
            ...
            #region HCI_LE_Create_Connection (OCF=0x000D)
            ...
            p = c.CommandParameters.Add("LE_Scan_Interval", 2, ParameterDataType.Time_625usec,
                ...
                "Time = N * 0.625 msec, Time Range: 2.5 msec to 10.24 seconds");
            p.SetData(new byte[] { 0x40, 0x00 }, 0); // 40msec
            p = c.CommandParameters.Add("LE_Scan_Window", 2, ParameterDataType.Time_625usec,
            ...
            p.SetData(new byte[] { 0x40, 0x00 }, 0);
            ...
            p.SetData(new byte[] { 0x80, 0x0C }, 0);
            ...
            #region HCI_LE_Create_Connection_Cancel (OCF=0x000E)
            ...
            #region HCI_LE_Read_White_List_Size (OCF=0x000F)
            ...
            #region HCI_LE_Clear_White_List (OCF=0x0010)
            ...
            #region HCI_LE_Add_Device_To_White_List (OCF=0x0011)
            ...
            #region HCI_LE_Remove_Device_From_White_List (OCF=0x0012)
            ...
            #region HCI_LE_Connection_Update (OCF=0x0013)
            ...
            #region HCI_LE_Set_Host_Channel_Classification (OCF=0x0014)
            ...
            #region HCI_LE_Read_Channel_Map (OCF=0x0015)
            ...
            #region HCI_LE_Read_Remote_Used_Features (OCF=0x0016)
            ...
            #region HCI_LE_Encrypt (OCF=0x0017)
            ...
            #region HCI_LE_Start_Encryption (OCF=0x0019)
            ...
            #region HCI_LE_Long_Term_Key_Request_Reply (OCF=0x001A)
            ...
            #region HCI_LE_Long_Term_Key_Request_Negative_Reply (OCF=0x001B)
            ...
            #region HCI_LE_Read_Supported_States (OCF=0x001C)
            ...
            c.ReturnParameters.Add("LE_States", 8, ParameterDataType.Bytes,
                "Bit00 Non-connectable Advertising State\n" +
                "Bit01 Scannable Advertising State\n" +
                "Bit02 Connectable Advertising State\n" +
                "Bit03 High Duty Cycle Directed Advertising State\n" +
                "Bit04 Passive Scanning State\n" +
                "Bit05 Active Sacnning State\n" +
                "Bit06 Initiating State\n" +
                "Bit07 Connection State(Slave Role)\n" +
                "Bit08 Non-connectable Advertising State, Passive Scanning State\n" +
                "Bit09 Scannable Advertising State, Passive Scanning State\n" +
                "Bit10 Connectable Advertising State, Passive Scanning State\n" +
                "Bit11 High Duty Cycle Directed Advertising State, Passive Scanning State\n" +
                "Bit12 Non-connectable Advertising State, Active Sacnning State\n" +
                "Bit13 Scannable Advertising State, Active Sacnning State\n" +
                "Bit14 Connectable Advertising State, Active Sacnning State\n" +
                "Bit15 High Duty Cycle Directed Advertising State, Active Sacnning State\n" +
                "Bit16 Non-connectable Advertising State, Initiating State\n" +
                "Bit17 Scannable Advertising State, Initiating State\n" +
                "Bit18 Non-connectable Advertising State, Connection State(Master Role)\n" +
                "Bit19 Scannable Advertising State, Connection State(Master Role)\n" +
                "Bit20 Non-connectable Advertising State, Connection State(Slave Role)\n" +
                "Bit21 Scannable Advertising State, Connection State(Slave Role)\n" +
                "Bit22 Passive Scanning State, Initiating State\n" +
                "Bit23 Active Sacnning State, Initiating State\n" +
                "Bit24 Passive Scanning State, Connection State(Master Role)\n" +
                "Bit25 Active Sacnning State, Connection State(Master Role)\n" +
                "Bit26 Passive Scanning State, Connection State(Slave Role)\n" +
                "Bit27 Active Sacnning State, Connection State(Slave Role)\n" +
                "Bit28 Initiating State, Connection State(Master Role)\n" +
                "Bit29 Low Duty Cycle Directed Advertising State\n" +
                "Bit30 Low Duty Cycle Directed Advertising State, Passive Scanning State\n" +
                "Bit31 Low Duty Cycle Directed Advertising State, Active Sacnning State\n" +
                "Bit32 Connectable Advertising State, Initiating State\n" +
                "Bit33 High Duty Cycle Directed Advertising State, Initiating State\n" +
                "Bit34 Low Duty Cycle Directed Advertising State, Initiating State\n" +
                "Bit35 Connectable Advertising State, Connection State(Master Role)\n" +
                "Bit36 High Duty Cycle Directed Advertising State, Connection State(Master Role)\n" +
                "Bit37 Low Duty Cycle Directed Advertising State, Connection State(Master Role)\n" +
                "Bit38 Connectable Advertising State, Connection State(Slave Role)\n" +
                "Bit39 High Duty Cycle Directed Advertising State, Connection State(Slave Role)\n" +
                "Bit40 Low Duty Cycle Directed Advertising State, Connection State(Slave Role)\n" +
                "Bit41 Initiating State, Connection State(Slave Role)\n" +
                "All bits not listed in this table, and all 0 are reserved for future use.");
            #endregion

            #region HCI_LE_Receiver_Test (OCF=0x001D)
            ...
            #region HCI_LE_Transmitter_Test (OCF=0x001E)
            ...
            #region HCI_LE_Test_End (OCF=0x001F)
            ...
            #region LE_Remote_Connection_Parameter_Request_Reply (OCF=0x0020)
            ...
            #region LE_Remote_Connection_Parameter_Request_Negative_Reply (OCF=0x0021)
            ...
            #region HCI_LE_Set_Data_Length (OCF=0x0022)
            ...
            #region HCI_LE_Read_Suggested_Default_Data_Length (OCF=0x0023)
            ...
            #region HCI_LE_Write_Suggested_Default_Data_Length (OCF=0x0024)
            ...
            #region HCI_LE_Read_Local_P-256_Public_Key (OCF=0x0025)
            ...
            #region HCI_LE_Generate_DHKey (OCF=0x0026)
            ...
            #region HCI_LE_Add_Device_To_Resolving_List (OCF=0x0027)
            ...
            #region HCI_LE_Remove_Device_From_Resolving_List (OCF=0x0028)
            ...
            #region HCI_LE_Clear_Resolving_List (OCF=0x0029)
            ...
            #region HCI_LE_Read_Resolving_List_Size (OCF=0x002A)
            ...
            #region HCI_LE_Read_Peer_Resolvable_Address (OCF=0x002B)
            ...
            #region HCI_LE_Read_Local_Resolvable_Address (OCF=0x002C)
            ...
            #region HCI_LE_Set_Address_Resolution_Enable (OCF=0x002D)
            ...
            #region HCI_LE_Set_Resolvable_Private_Address_Timeout (OCF=0x002E)
            ...
            #region HCI_LE_Read_Maximum_Data_Length (OCF=0x002F)
            ...
            /*
             * Added commands of BlueTooth v5.0
             * */
            #region HCI_LE_Read_PHY (OCF=0x0030)
            ...
            #region HCI_LE_Set_Default_PHY (OCF=0x0031)
            ...
            #region HCI_LE_Set_PHY (OCF=0x0032)
            ...
            #region HCI_LE_Enhanced_Receiver_Test (OCF=0x0033)
            ...
            #region HCI_LE_Enhanced_Transmitter_Test (OCF=0x0034)
            ...
            #region HCI_LE_Set_Advertising_Set_Random_Address (OCF=0x0035)
            ...
            #region HCI_LE_Set_Extended_Advertising_Parameters (OCF=0x0036)
            ...
            p.SetData(new byte[] { 0x00, 0x08, 0x00 }, 0);
            ...
            #region HCI_LE_Set_Extended_Advertising_Data (OCF=0x0037)
            ...
            #region HCI_LE_Set_Extended_Scan_Response_Data (OCF=0x0038)
        ...
        private void InitVendorSpecificCommands()
        {
            Command c;
            //Parameter p;

            CommandGroups.Add("Vendor Specific Commands", 0x3F);
            CommandGroup cg = CommandGroups[CommandGroups.Count - 1];

            #region HCI_Vendor_Write_BB_Register (OCF=0x066)
            ...
            /* Add return parameters */
            c.ReturnParameters.Add("Status", 1, ParameterDataType.Status,
                "0x00 HCI_Vendor_Write_BB_Register command succeeded.\n" +
                "0x01-0xFF HCI_Vendor_Write_BB_Register command failed.");
            #endregion

            #region HCI_Vendor_Read_BB_Register (OCF=0x067)
            ...
            /* Add return parameters */
            c.ReturnParameters.Add("Status", 1, ParameterDataType.Status,
                "0x00 HCI_Vendor_Read_BB_Register command succeeded.\n" +
                "0x01-0xFF HCI_Vendor_Read_BB_Register command failed.");
            c.ReturnParameters.Add("Data", 2, ParameterDataType.Bytes,
                "RFC register data");
            #endregion

            #region HCI_Vendor_Read_RFC_Register (OCF=0x149)
            ...
            /* Add return parameters */
            c.ReturnParameters.Add("Status", 1, ParameterDataType.Status,
                "0x00 HCI_Vendor_Read_RFC_Register command succeeded.\n" +
                "0x01-0xFF HCI_Vendor_Read_RFC_Register command failed.");
            c.ReturnParameters.Add("Data", 4, ParameterDataType.Bytes,
                "RFC register data");
            #endregion

            #region HCI_Vendor_Write_RFC_Register (OCF=0x14A)
            ...
            /* Add return parameters */
            c.ReturnParameters.Add("Status", 1, ParameterDataType.Status,
                "0x00 HCI_Vendor_Write_RFC_Register command succeeded.\n" +
                "0x01-0xFF HCI_Vendor_Write_RFC_Register command failed.");
            #endregion
        }
        ...
        #region Initialize HCI events

        private void InitCommonEvents()
        {
            Event e;

            #region Disconnection Complete Event (EventCode=0x05)
            e = Events.Add("Disconnection Complete Event", 0x05, 0x00,
            ...
            #region Encryption Change Event (EventCode=0x08)
            e = Events.Add("Encryption Change Event", 0x08, 0x00,
            ...
            #region Read Remote Version Information Complete Event (EventCode=0x0C)
            e = Events.Add("Read Remote Version Information Complete Event", 0x0C, 0x00,
            ...
            #region Command Complete Event (EventCode=0x0E)
            e = Events.Add("Command Complete Event", 0x0E, 0x00,
            ...
            e.Parameters.Add("Num_HCI_Command_Packets", 1, ParameterDataType.Number,
                ...
                "Range for N: 0 – 255");
            e.Parameters.Add("Command_Opcode", 2, ParameterDataType.OpCode,
                "Opcode of the command which caused this event.");
            #endregion

            #region Command Status Event (EventCode=0x0F)
            e = Events.Add("Command Status Event", 0x0F, 0x00,
            ...
            #region Hardware Error Event (EventCode=0x10)
            e = Events.Add("Hardware Error Event", 0x10, 0x00,
            ...
            #region Number Of Completed Packets Event (EventCode=0x13) [Array parameter]
            e = Events.Add("Number Of Completed Packets Event", 0x13, 0x00,
            ...
            #region Data Buffer Overflow Event (EventCode=0x1A)
            e = Events.Add("Data Buffer Overflow Event", 0x1A, 0x00,
            ...
            #region Encryption Key Refresh Complete Event (EventCode=0x30)
            e = Events.Add("Encryption Key Refresh Complete Event", 0x30, 0x00,
                "The Encryption Change event is used to indicate that the change of the\n" +
                "encryption mode has been completed.");
            /* Add HCI event parameters */
            e.Parameters.Add("Status", 1, ParameterDataType.Status,
            ...
            #region Authenticated Payload Timeout Expired Event (EventCode=0x57)
            e = Events.Add("Authenticated Payload Timeout Expired Event", 0x57, 0x00,
        ...
        // LE meta event code = 0x3E
        private void InitLEMetaEvents()
        {
            Event e;

            #region LE Connection Complete Event (SubEventCode=0x01)
            e = Events.Add("LE Connection Complete Event", 0x3E, 0x01,
            ...
            #region LE Advertising Report Event (SubEventCode=0x02) [Array parameter]
            e = Events.Add("LE Advertising Report Event", 0x3E, 0x02,
            ...
            e.Parameters.Add("Num_Reports", 1, ParameterDataType.Number,
                ...
                ParameterType.ArrayIndicator, 6);
            ...
            e.Parameters.Add("Length_Data[i]", 1, ParameterDataType.Number,
                ...
                ParameterType.ArrayData | ParameterType.ResizableIndicator);
            e.Parameters.Add("Data[i]", 31, ParameterDataType.Bytes,
                ...
                ParameterType.ArrayData | ParameterType.ResizableData);
            ...
            #region LE Connection Update Complete Event (SubEventCode=0x03)
            e = Events.Add("LE Connection Update Complete Event", 0x3E, 0x03,
            ...
            #region LE Read Remote Used Features Complete Event (SubEventCode=0x04)
            e = Events.Add("LE Read Remote Used Features Complete Event", 0x3E, 0x04,
            ...
            #region LE Long Term Key Request Event (SubEventCode=0x05)
            e = Events.Add("LE Long Term Key Request Event", 0x3E, 0x05,
            ...
            #region LE Remote Connection Parameter Request Event (SubEventCode=0x06)
            e = Events.Add("LE Long Term Key Request Event", 0x3E, 0x06,
            ...
            #region LE Data Length Change Event (SubEventCode=0x07)
            e = Events.Add("LE Data Length Change Event", 0x3E, 0x07,
                "This event indicates to the master’s Host or the slave’s Host that the remote\n" +
                "device is requesting a change in the connection parameters.\n" +
                "The Host replies either with the HCI LE Remote Connection Parameter Request Reply\n" +
                "command or the HCI LE Remote Connection Parameter Request Negative Reply command.");
            ...
            #region LE Read Local P-256 Public Key Complete Event (SubEventCode=0x08)
            e = Events.Add("LE Read Local P-256 Public Key Complete Event", 0x3E, 0x08,
            ...
            #region LE Generate DHKey Complete Event (SubEventCode=0x09)
            e = Events.Add("LE Generate DHKey Complete Event", 0x3E, 0x09,
            ...
            #region LE Enhanced Connection Complete Event (SubEventCode=0x0A)
            e = Events.Add("LE Enhanced Connection Complete Event", 0x3E, 0x0A,
            ...
            #region LE Direct Advertising Report Event (SubEventCode=0x0B) [Array Parameter]
            e = Events.Add("LE Direct Advertising Report Event", 0x3E, 0x0B,
            ...
            /* 
             * Added events for BlueTooth v5.0
             * */
            #region LE PHY Update Complete Event (SubEventCode=0x0C)
            e = Events.Add("LE PHY Update Complete Event", 0x3E, 0x0C,
            ...
            #region LE Extended Advertising Report Event (SubEventCode=0x0D) [Array parameter]
            e = Events.Add("LE Extended Advertising Report Event", 0x3E, 0x0D,
            ...
            #region LE Periodic Advertising Sync Established Event (SubEventCode=0x0E)
            e = Events.Add("LE Periodic Advertising Sync Established Event", 0x3E, 0x0E,
            ...
            #region LE Periodic Advertising Report Event (SubEventCode=0x0F)
            e = Events.Add("LE Periodic Advertising Report Event", 0x3E, 0x0F,
            ...
            #region LE Periodic Advertising Sync Lost Event (SubEventCode=0x10)
            e = Events.Add("LE Periodic Advertising Sync Lost Event", 0x3E, 0x10,
            ...
            #region LE Scan Timeout Event (SubEventCode=0x11)
            e = Events.Add("LE Scan Timeout Event", 0x3E, 0x11,
            ...
            #region LE Advertising Set Terminated Event (SubEventCode=0x12)
            e = Events.Add("LE Advertising Set Terminated Event", 0x3E, 0x12,
            ...
            #region LE Scan Request Received Event (SubEventCode=0x13)
            e = Events.Add("LE Scan Request Received Event", 0x3E, 0x13,
            ...
            #region LE Channel Selection Algorithm Event (SubEventCode=0x14)
            e = Events.Add("LE Channel Selection Algorithm Event", 0x3E, 0x14,
        ...
        #endregion // HCI commands and events initialization methods
    }
    #endregion
