...
namespace SKAICHIPS_Verificationin
{
    public partial class HCIControlForm : Form
    {
        #region Form information class
        [Serializable]
        ...
        private BlueTooth.HCI.HCIManager HciMgr = null;
        private JLcLib.Excel.ExcelManager xlMgr = null;
        ...
        public HCIControlForm()
        {
            ...
            HciMgr = new BlueTooth.HCI.HCIManager()
            {
        ...
        {
            // 1. Init Connection group box
            SetPortOpenCloseButtonEnabled(true);
            FindSerialPorts(); // Initialize serial port
            FindUsbDevices(); // Initialize USB port

            // 2. Init HCI command treeview
            ((System.ComponentModel.ISupportInitialize)(this.HCISplitContainer)).BeginInit();
            HCISplitContainer.SplitterDistance = (int)formInfo.SplitDistance;//(int)(formInfo.SplitDistance * this.Size.Width);
            ...
            // 3. Init HCI Log tap control

            // 4. Init HCI script treeview
        ...
        {
            // 1. Stored Connection group box
            // 2. Stored HCI command treeview
        ...
        #region Connection group events and cotrol methods
        /// <summary>
        /// Finds for available serial ports
        /// </summary>
        ...
        /// <summary>
        /// Finds for available USB devices
        /// </summary>
        ...
        private void PortOpenButton_Click(object sender, EventArgs e)
        {
            if (!HciMgr.IsOpen)
            {
                ...
                if ((PortTabControl.SelectedIndex == 0) && (SerialPortComboBox.SelectedIndex >= 0)) // For UART
                {
                ...
                else if ((PortTabControl.SelectedIndex == 1) && (USBDevicesComboBox.SelectedIndex >= 0))// For USB
                {
                ...
                if (HciMgr.IsOpen)
                {
                    ...
                    // test code
                    //HciMgr.HCICommands[0].Commands[0].Send();
                }
            }
        }
        ...
        #region Tree group events and cotrol methods
        ...
        #region HCI command tree events
        ...
        #region HCI tree view context menu event
        ...
        #region HCI command parameter group box events and control methods
            ...
            if (SelectedHciParameter != null)
            {
                ...
                finally
                {
                    ...
                    else
                    {
                        ...
                        // Set flexable size of array parameter
                        // BlueTooth.HCI.Parameter Para = null;
                        // TBD
                    }
                }
            }
        ...
        #region HCI Log tap control events and control methods
        ...
        private void SaveLogWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            xlMgr.File.New();
            string FileName = System.IO.Directory.GetCurrentDirectory() + "\\HCI_Log_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".xlsx";

            if (HciLogDataGridView != null)
            {
                DataTable dt = HciLogDataGridView.DataSource as DataTable;
                xlMgr.Sheet.Add("HCI Log");
                xlMgr.Sheet.Select("HCI Log");
                xlMgr.Cell.Write(dt);
                xlMgr.Cell.WriteFormat(HciLogDataGridView);
                xlMgr.File.SaveAs(FileName);
            }
        ...
        #region HCI stript tap control events and control methods
        ...
        private void SaveHciScriptFile(string FileName)
        {
            ...
            {
                formatter.Serialize(fs, Cmd.Name);
                foreach (BlueTooth.HCI.Parameter Para in Cmd.CommandParameters)
                {
                    formatter.Serialize(fs, Para.Data);
                }
            }
            fs.Close();
        }
        ...
        private void SaveAsHciScriptFile()
        {
            using (SaveFileDialog FileDlg = new SaveFileDialog())
            {
                ...
                if (formInfo.SelectedHciScriptFileName == "")
                    FileDlg.InitialDirectory = System.IO.Directory.GetCurrentDirectory() + "\\HCI_Script";
                else
        ...
        private bool LoadHciScriptFile(string FileName)
        {
            ...
            if (System.IO.File.Exists(FileName))
            {
                ...
                try
                {
                    ...
                    while (br.PeekChar() != -1)
                    {
                        string CommandName = (string)formatter.Deserialize(fs);
                        for (int i = 0; i < HciMgr.HCICommands.Count; i++)
                        {
                            BlueTooth.HCI.Command TempCmd = HciMgr.HCICommands[i].Commands.GetCommand(CommandName);
                            if (TempCmd != null)
                            {
                                BlueTooth.HCI.Command Cmd = TempCmd.Clone();
                                HCIScript.Add(Cmd);
                                HCIScriptTreeView.Nodes.Add(Cmd.CommandNode);
                                Cmd.SendCommand = TempCmd.SendCommand;
                                foreach (BlueTooth.HCI.Parameter Para in Cmd.CommandParameters)
                                    Para.Data = (byte[])formatter.Deserialize(fs);
                                break;
                            }
                        }
                    }
                ...
                catch { MessageBox.Show("No HCI Command Script File!!"); }
                if (br != null) br.Close();
                if (fs != null) fs.Close();
            }
            return Status;
        ...
        #region HCI script tree view context menu event
        ...
        #region Test tab control events and methods
        ...
        private void RunModulationTest(object sender, DoWorkEventArgs e)
        {
            ...
            TxTest = HciMgr.GetCommand(0x0C03); // Get reset command
            TxTest.Send();
            TestEnd = HciMgr.GetCommand(0x201F); // Get Test end command

            TxTest = HciMgr.GetCommand(0x201E); // Get HCI_LE_Transmitter_Test command
            TxTest.CommandParameters[0].Data[0] = 0x13; // Tx frequency (channel 19)
            TxTest.CommandParameters[1].Data[0] = 37; // Length of test data (37 bytes)

            while (!HciTestWorker.CancellationPending)
            {
                TxTest.CommandParameters[2].Data[0] = 0x01; // Packet_Payload (0xF0)
                TxTest.Send();
                System.Threading.Thread.Sleep(30);
                TestEnd.Send();
                TxTest.CommandParameters[2].Data[0] = 0x02; // Packet_Payload (0xAA)
                TxTest.Send();
                System.Threading.Thread.Sleep(30);
                TestEnd.Send();
            }
        ...
        #region BLE connection tab event and methods
...
namespace BlueTooth
{
    ...
    namespace HCI
    {
        #region HCI control delegates
        /// <summary>
        /// This delegate is used to write HCI command to target device.
        /// </summary>
        /// <param name="command">HCI command class</param>
        /// <returns>true is success to write.</returns>
        public delegate bool WriteCommand(Command command);
        /// <summary>
        /// This delegate is used to set parameters data of ParameterCollection.
        /// </summary>
        /// <param name="Parameters">ParameterCollection class</param>
        /// <param name="DataBuffer">Parameters data to be set</param>
        ...
        /// <summary>
        /// Parameter type for controlling parameter
        /// </summary>
        public enum ParameterType
        {
            /// <summary>Parameter of normal data type</summary>
            Data,
            /// <summary>
            /// Array size indicator parameter.
            /// It is size of all next ArrayData parameters.
            /// </summary>
            ArrayIndicator,
            /// <summary>
            /// Parameter of array data type.
            /// Array size is changed by data of ArraySizeIndicator parameter according to Bluetooth specification.
            /// </summary>
            ArrayData,
            /// <summary>
            /// Flexible data size indicator parameter.
            /// Next size of flexible data parameter is changed by data of FlexibleDataSizeIndicator type parameter.
            /// </summary>
            ResizableIndicator,
            /// <summary>Resiable data parameter.</summary>
            ResizableData,
            /// <summary>Resizable and array data parameter.</summary>
            ArrayDataAndResizableIndicator,
            /// <summary>Resizable and array data parameter.</summary>
            ArrayDataAndResizableData,
        }
        /// <summary>
        /// Parameter data type for processing parameter.
        /// </summary>
        public enum ParameterDataType
        {
            /// <summary>Signed byte, 1 byte</summary>
            S8,
            /// <summary>Unsigned short, 2 bytes</summary>
            U16,
        ...
        public class Parameter
        {
            ...
            /// <summary>Gets or sets parameter data</summary>
            public byte[] Data { get; set; }
            /// <summary>Gets or sets parameter description</summary>
            public string Description { get; set; }
            /// <summary>Gets or sets parameter data information</summary>
            public string Information { get; set; }
            /// <summary>Gets or sets color of parameter data information</summary>
            public Color InfoColor { get; set; }
            private ParameterDataType ParaDataType;
            private ParameterType ParaType;
            /// <summary>Gets parameter tree node</summary>
            public TreeNode Node { get; set; }
            /// <summary>Parent parameter collection</summary>
            public ParameterCollection Parent { get; set; }
            /// <summary>This event is occurred when parameter size is changed.</summary>
            ...
            /// <param name="Size">Parameter length in bytes</param>
            /// <param name="DataType">Parameter data type for encoding</param>
            /// <param name="Description">Parameter description</param>
            /// <param name="Type">Parameter action type</param>
            ...
            #region Evnets control methods
            /// <summary>
            /// This event is occurred when parameter size is changed.
            /// </summary>
            ...
            #region Properties
            /// <summary>Gets or sets parameter length in bytes</summary>
            public byte Size
            {
                get { return ParaSize; }
                set
            ...
            /// <summary>Gets parameter data type such as byte, char</summary>
            public ParameterDataType DataType { get { return ParaDataType; } }
            /// <summary>Gets parameter action type</summary>
            public ParameterType Type { get { return ParaType; } }
            #endregion
            ...
            /// </summary>
            /// <param name="Para">Parameter class</param>
            /// <param name="DataBuffer">DataBuffer is set to data of parameter</param>
            /// <param name="StartIndex">Start index of DataBuffer</param>
            /// <returns>New start index for next parameter</returns>
        ...
        /// <summary>
        /// HCI parameters collection class
        /// </summary>
        public class ParameterCollection : IEnumerator, IEnumerable
        {
            ...
            /// Constructor
            /// </summary>
            /// <param name="Nodes">Registers tree node collection</param>
            ...
            /// <summary>Gets total number of parameter length in bytes</summary>
            public byte TotalLength { get { return TotalParameterLength; } }
            ...
            /// <summary>
            /// This method is used to add the parameter at this collection
            /// </summary>
            /// <param name="Name">Parameter name</param>
            ...
            /// <summary>
            /// This method is used to insert parameter to this collection
            /// </summary>
            ...
            /// <summary>
            /// This method is used to delete parameter from this items collection
            /// </summary>
            ...
            /// <summary>
            /// This method is clear all parameters
            /// </summary>
            public void Clear()
            {
                TotalParameterLength = 0;
            ...
            /// </summary>
            /// <param name="Name">Parameter name</param>
            /// <returns>Parameter class</returns>
            ...
            /// <summary>
            /// This method is used to get next parameter by item name
            /// </summary>
            /// <param name="Name">Parameter name</param>
            /// <returns>Parameter class</returns>
            ...
            #region Static methods
            /// <summary>
            /// This method is used to set parameters data of ParameterCollection.
            /// </summary>
            /// <param name="Parameters">ParameterCollection class</param>
            /// <param name="DataBuffer">Parameters data to be set</param>
            /// <param name="StartIndex">Start index of DataBuffer</param>
            public static void SetParameters(ParameterCollection Parameters, byte[] DataBuffer, int StartIndex)
            {
                ...
                for(int ParaIndex = 0; ParaIndex < Parameters.Count; ParaIndex++)
                {
                    ...
                    // Additional paramter processing
                    if (Parameters[ParaIndex].Type == ParameterType.ArrayIndicator)
                    {
                        ...
                        // Get Arrayed parameters and remainder parameters.
                        for (int i = 1; i < Parameters.Count; i++)
                        {
                            if ((Parameters[ParaIndex + i].Type == ParameterType.ArrayData) // Get arrayed parameters
                        ...
                        // Remove arrayed parameters
                        for(int i = 0; i < RemoveCount; i++)
                            Parameters.RemoveAt(ParaIndex + 1);
                        // Insert arrayed parameters
        ...
        public class Command
        {
            ...
            public short OpCode { get { return (short)((OpGroupField << 10) | OpCommandField); } }
            /// <summary>Gets OGF (6 bits)</summary>
            public int OGF { get { return OpGroupField; } }
            /// <summary>Gets OCF (10 bits)</summary>
            public int OCF { get { return OpCommandField; } }
            /// <summary>Gets or sets command description</summary>
            public string Description { get { return CommandDescription; } set { CommandDescription = value; } }
            /// <summary>Gets or sets command paramters</summary>
            public ParameterCollection CommandParameters { get { return CommandParaCollection; } set { CommandParaCollection = value; } }
            /// <summary>Gets or sets return paramters</summary>
            public ParameterCollection ReturnParameters { get { return ReturnParaCollection; } set { ReturnParaCollection = value; } }
            /// <summary>Gets or sets command tree node</summary>
            public TreeNode CommandNode { get { return CommandTreeNode; } set { CommandTreeNode = value; } }
            /// <summary>Gets or sets command tree node</summary>
            public TreeNode ReturnNode { get { return ReturnTreeNode; } set { ReturnTreeNode = value; } }
            #endregion

            #region Command control functions
            /// <summary>
            /// Gets command packet
            /// </summary>
            /// <returns>Command packet data</returns>
            public byte[] GetCommandPacket()
            {
                List<byte> Data = new List<byte>
                {
                    (byte)(OpCode & 0xff), // OpCode LSB 8bit
                    (byte)(OpCode >> 8), // OpCode MSB 8bit
                    CommandParaCollection.TotalLength // Parameter total length
                };
            ...
            /// <summary>
            /// Sets return parameters by received data.
            /// </summary>
            /// <param name="DataBuffer">Bytes buffer for return parameter</param>
            /// <param name="StartIndex">Start index of return paramter at DataBuffer</param>
            /// <returns></returns>
            ...
            /// <summary>
            /// Send HCI command to connected device.
            /// </summary>
            /// <returns></returns>
            public bool Send()
            {
            ...
            /// <summary>
            /// Copies command class and entire parameters.
            /// </summary>
            /// <returns></returns>
        ...
        public class CommandCollection : IEnumerator, IEnumerable
        {
            ...
            /// <summary>
            /// This method is used to add command class to this collection.
            /// </summary>
            /// <param name="Name">Command Name</param>
            /// <param name="OCF">OpCode command field (10 bits)</param>
            /// <param name="Description">Command description</param>
            ...
            /// <summary>
            /// This method is used to insert command to this collection
            /// </summary>
            ...
            /// <summary>
            /// This method is used to delete command from this collection.
            /// </summary>
            ...
            /// <summary>
            /// This method is used to clear all registers
            /// </summary>
            public void Clear()
            {
            ...
            /// <summary>
            /// This method is used to get command class in this collection by name.
            /// </summary>
            /// <param name="Name"> command name </param>
            /// <returns>register class</returns>
        ...
        public class CommandGroup
        {
            ...
            public string Name { get { return CommandGroupName; } set { CommandGroupName = value; CommandGroupNode.Text = value; } }
            /// <summary>Gets OGF (6 bits)</summary>
            public int OGF { get { return OpGroupField; } }
            /// <summary>Gets registers collection</summary>
            public CommandCollection Commands { get { return CmdCollection; } set { CmdCollection = value; } }
            /// <summary>Gets or sets register block tree node</summary>
            public TreeNode Node { get { return CommandGroupNode; } set { CommandGroupNode = value; } }
            #endregion

            #region Command group control functions
            #endregion
        }
        #endregion

        #region HCI event classes
        /// <summary>
        /// HCI command class
        /// </summary>
        public class Event
        {
            ...
            /// <summary>Gets event code(1 byte)</summary>
            public byte Code { get { return EventCode; } }
            /// <summary>Gets or sets command description</summary>
            public string Description { get { return EventDescription; } }
            /// <summary>Gets or sets paramters</summary>
            public ParameterCollection Parameters { get { return ParaCollection; } set { ParaCollection = value; } }
            /// <summary>Sub-events collection for LE meta events</summary>
            public EventCollection SubEvents {  get { return SubEventCollection; } set { SubEventCollection = value; } }
            /// <summary>Gets or sets command tree node</summary>
            public TreeNode Node { get { return EventTreeNode; } set { EventTreeNode = value; } }
            #endregion

            #region HCI Event control functions
            /// <summary>
            /// Sets return parameters by received data.
            /// </summary>
            /// <param name="DataBuffer">Bytes buffer for return parameter</param>
        ...
        public class EventCollection : IEnumerator, IEnumerable
        {
            ...
            /// <summary>
            /// This method is used to get event class in this collection by name.
            /// </summary>
            ...
            /// <summary>
            /// This method is used to get event class in this collection by event type
            /// </summary>
            /// <param name="Code">Event code</param>
            /// <returns>Event class</returns>
        ...
        public class ConnectionInfo
        {
            ...
            public string ConnHandle { get; set; }
        ...
        public class HCIManager
        {
            ...
            private LibUsbDotNet.UsbEndpointWriter UsbDataWriter; // ACL data writer.(Endpoint = 0x02, Bulk(OUT))
            private LibUsbDotNet.UsbEndpointReader UsbDataReader; // ACL data reader.(Endpoint = 0x82, Bulk(IN))
            // USB isochronous interface types are had some alternate ID.
            private List<UsbEndpointWriter> UsbIsochWriter = new List<UsbEndpointWriter>(); // Isochronous writer.(Endpoint = 0x03, Isochronous(OUT))
            private List<UsbEndpointReader> UsbIsochReader = new List<UsbEndpointReader>(); // Isochronous reader.(Endpoint = 0x83, Isochronous(IN))
            ...
            public DataGridView HciLogView { get; set; }
            public DataGridView ConnLogView { get; set; }
            ...
            public List<ConnectionInfo> AdvertisingReports { get; set; }
            #endregion
            ...
            #region Properties
            /// <summary>Gets the open or closed status(true is open)</summary>
            public bool IsOpen { get { return Opened; } }
            /// <summary>Gets the connection status message</summary>
            public string ConnMessage {  get { return ConnectionMessage; } }
            /// <summary>Gets or sets HCI command group</summary>
            public List<CommandGroup> HCICommands { get { return CmdGroupList; } set { CmdGroupList = value; } }
            /// <summary>Gets or sets HCI event collection</summary>
            public EventCollection HCIEvents { get { return EvtCollection; } set { EvtCollection = value; } }
            /// <summary>Gets or sets DataGridView for HCI log</summary>
            public DataGridView HCILog_DataGridView
            {
                get { return HciLogView; }
                set
                {
                    HciLogView = value;
                    if (HciLogView != null)
            ...
            /// <summary>Gets DataTable for HCI log</summary>
            public DataTable HCILog { get { return dtHciLog; } }
            #endregion

            #region Connection control methods
            /// <summary>
            ...
            #region Transport control methods
            ...
            private void SetIndividualCommandControl(Command Cmd)
            {
                switch (Cmd.Name)
                {
                    ...
                    case "HCI_LE_Create_Connection":
                        ...
                        //    CurLLState = LinkLayerState.Connection;
                        break;
                }
            }
            ...
            private bool SendCommand(Command Cmd)
            {
                ...
                else if (CurComnType == ComnType.Serial)
                {
                    ...
                    WriteBuffer[0] = 0x01; // HCI command packet type is 0x01.
            ...
            private void UsbEventReader_DataReceived(object sender, EndpointDataEventArgs e)
            {
                if (USB != null)
                {
                    ...
                    {
                        RcvQueue.Enqueue(0x04); // Set HCI packet indicator. 0x04 is HCI event packet
                        if (e.Buffer[1] > (e.Count - 2)) // 2 = 1 byte event code +  1 byte payload length
            ...
            #region Received message processing methods
            ...
            byte EventCode = 0; // For HCI events
            //byte SubEventCode = 0; // For LE meta events of the HCI events
            short ACLHandle = 0; // For HCI ACL data
            byte PacketBoudaryFlag = 0;  // For HCI ACL data
            byte BrodcastFlag = 0;  // For HCI ACL data
            short ConnectionHandle = 0; // For HCI Synchronous data
            byte PacketStatusFlag = 0; // For HCI Synchronous data
            #endregion
            ...
            private void ProcRcvMessage_DoWork()
            {
                ...
                while (IsRunning)
                {
                    if (RcvQueue.Count > 0)
                    {
                        ...
                        if (RcvFailCount == MaxRcvFailCount) // Failed to receive packet
                        {
                            RcvQueue.Clear();
                            ResetPacketInfo();
                        }
            ...
            #region HCI packet processing methods
            /// <summary>
            /// Process the HCI event packet.
            /// </summary>
            /// <returns>
            /// If true, event packet processing is succeed.
            /// If false, event packet isn't completed to receive or failed to analysis.
            /// </returns>
            private bool ProcEventPacket()
            {
                ...
                if((PayloadLength <= RcvQueue.Count) && (PayloadLength < uint.MaxValue))
                {
                    ...
                    Command Cmd = null;
                    if (Evt != null) // HCI event
                    {
                        // Process HCI event
                        Evt.SetParameters(Packet.ToArray(), 0);
                        // Additional HCI event processing
                        switch (EventCode)
                        {
                            case (byte)EventCodes.Command_Complete_Event: // In Command Complete Event, sets HCI command response parameters
                                ...
                                break;
                            case (byte)EventCodes.LE_Meta_Event: // Sets LE sub-events of the LE meta event(0x3E)
            ...
            /// <summary>
            /// Process the HCI ACL data packet.
            /// </summary>
            /// <returns>
            /// If true, event packet processing is succeed.
            /// If false, event packet isn't completed to receive or failed to analysis.
            ...
            /// <summary>
            /// Process the HCI synchronous packet.
            /// </summary>
            /// <returns>
            /// If true, event packet processing is succeed.
            /// If false, event packet isn't completed to receive or failed to analysis.
            ...
            #endregion // HCI packet processing methods

            #endregion // Received message processing methods

            #region HCI Log DataGridView control methods and events
            ...
            private void SetHciEventLog(Event Evt, Command Cmd, byte[] Packet)
            {
                HciLogView.Invoke(new MethodInvoker(delegate ()
                {
                    // If there is events, It will be run.
                    if (Evt != null)
                    {
                        byte SubEventCode = 0;
                        Event SubEvent = null;
                        ...
                        // If there is LE Meta events, It will be run.
                        if(SubEvent != null)
                        {
                    ...
                    // If there is command response, It will be run.
                    if (Cmd != null)
                    {
            ...
            private void InitLinkControlCommands(CommandGroup cg)
            {
                ...
                #region HCI_Set_Connection_Encryption (OCF=0x0013)
                ...
                #endregion HCI_Set_Connection_Encryption (OCF=0x0013)
            }
            ...
            private void InitControlAndBasebandCommands(CommandGroup cg)
            {
                ...
                #region HCI_Host_Number_Of_Completed_Packets (0CF=0x035)
            ...
            private void InitInformationalParameters(CommandGroup cg)
            {
                ...
                #region HCI_Read_Local_Supported_Codecs (OCF=0x00B)
            ...
            #region Initialize HCI commands for Vol2, Part E, 7.8 LE Controller Commands
            private void InitLEControllerCommand(CommandGroup cg)
            {
                Command c;
                Parameter p;

                #region HCI_LE_Set_Event_Mask (OCF=0x0001)
                ...
                #region HCI_LE_Read_Local_Supported_Features (OCF=0x0003)
                ...
                p.Data = new byte[] { 0x10, 0x00 }; // 10msec
                ...
                p = c.CommandParameters.Add("LE_Scan_Interval", 2, ParameterDataType.Time_625usec,
                    ...
                    "Time = N * 0.625 msec, Time Range: 2.5 msec to 10.24 seconds");
                p.Data = new byte[] { 0x40, 0x00 }; // 40msec
                p = c.CommandParameters.Add("LE_Scan_Window", 2, ParameterDataType.Time_625usec,
            ...
            private void InitLEMetaEvents(Event LEMetaEvent)
            {
                ...
                #region LE Advertising Report Event (SubEventCode=0x02)
                ...
                #region LE Direct Advertising Report Event (SubEventCode=0x0B)
                ...
                #region LE Extended Advertising Report Event (SubEventCode=0x0D)
            ...
            private void InitEvents()
            {
                ...
                #region Number Of Completed Packets Event (EventCode=0x13)
                ...
                #region LE meta Event (EventCode=0x3E)
